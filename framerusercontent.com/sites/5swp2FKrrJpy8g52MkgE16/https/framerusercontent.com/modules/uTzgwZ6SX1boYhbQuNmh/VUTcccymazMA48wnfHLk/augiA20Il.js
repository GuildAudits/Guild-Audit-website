...
import {
    NumberCounter
} from "https://framerusercontent.com/modules/A2OI4bCEoMS2zbzIfNkp/q61YnFc5bIQjZwqMHzhH/Counter.js";
import Ticker from "https://framerusercontent.com/modules/B2xAlJLcN0gOnt11mSPw/jyRNgY7vYWXe6t31T0wo/Ticker.js";
import ChromaBackground from "https://framerusercontent.com/modules/xaswehZWsdrg2vflyKZT/bHKLZKMusvnTd9VyoQC7/ChromaBGs.js";
import Grid from "#framer/local/canvasComponent/DUVGMZfTQ/DUVGMZfTQ.js";
import FaqArea from "#framer/local/canvasComponent/FTvnB1zor/FTvnB1zor.js";
import CardsFeatureCard2 from "#framer/local/canvasComponent/KGFv19ZgP/KGFv19ZgP.js";
import Footer from "#framer/local/canvasComponent/Nay6sUX2m/Nay6sUX2m.js";
import PillPill from "#framer/local/canvasComponent/oCJKJKnRV/oCJKJKnRV.js";
import NavigationTopbar from "#framer/local/canvasComponent/vwOltRhhT/vwOltRhhT.js";
import ButtonGlowStroke from "#framer/local/canvasComponent/wsOzXECb4/wsOzXECb4.js";
import * as sharedStyle1 from "#framer/local/css/ferGDeq75/ferGDeq75.js";
import * as sharedStyle from "#framer/local/css/Sn1ggcgQ3/Sn1ggcgQ3.js";
import metadataProvider from "#framer/local/webPageMetadata/augiA20Il/augiA20Il.js";
const NavigationTopbarFonts = getFonts(NavigationTopbar);
const PillPillFonts = getFonts(PillPill);
const ContainerWithFX = withFX(Container);
const RichTextWithFX = withFX(RichText);
const ButtonGlowStrokeFonts = getFonts(ButtonGlowStroke);
...
const CardsFeatureCard2Fonts = getFonts(CardsFeatureCard2);
const FaqAreaFonts = getFonts(FaqArea);
const GridFonts = getFonts(Grid);
const MotionDivWithFX = withFX(motion.div);
const FooterFonts = getFonts(Footer);
const breakpoints = {
    jeCnrh3kk: "(min-width: 1280px) and (max-width: 1518.98px)",
    Q1XUigOVv: "(max-width: 767.98px)",
    WQLkyLRf1: "(min-width: 1519px)",
    XWGQJU3bM: "(min-width: 768px) and (max-width: 1279.98px)"
};
const isBrowser = () => typeof document !== "undefined";
const serializationHash = "framer-7mOOl";
...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const isDisplayed = () => {
        ...
        if (["XWGQJU3bM", "Q1XUigOVv"].includes(baseVariant)) return true;
        return false;
    };
    const isDisplayed1 = () => {
        if (!isBrowser()) return true;
        if (["XWGQJU3bM", "Q1XUigOVv"].includes(baseVariant)) return false;
        return true;
    };
    const isDisplayed2 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "Q1XUigOVv") return false;
        return true;
    };
    const router = useRouter();
    const isDisplayed3 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "XWGQJU3bM") return false;
        return true;
    };
    const isDisplayed4 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "XWGQJU3bM") return true;
        return false;
    };
    const isDisplayed5 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "Q1XUigOVv") return true;
        return false;
    };
    const elementId = useRouteElementId("c2ZynsCbs");
    const ref1 = React.useRef(null);
    const isDisplayed6 = () => {
        if (!isBrowser()) return true;
        if (["jeCnrh3kk", "XWGQJU3bM", "Q1XUigOVv"].includes(baseVariant)) return false;
        return true;
    };
    const isDisplayed7 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "jeCnrh3kk") return true;
        return false;
    };
    const isDisplayed8 = () => {
        if (!isBrowser()) return true;
        if (baseVariant === "jeCnrh3kk") return false;
        return true;
    };
    const elementId1 = useRouteElementId("bj_yV4awM");
    ...
    return /*#__PURE__*/ _jsx(GeneratedComponentContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsxs(LayoutGroup, {
            ...
            children: [ /*#__PURE__*/ _jsx(HTMLStyle, {
                value: "html body { background: var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, rgb(255, 255, 255)); }"
                ...
                children: [isDisplayed() && /*#__PURE__*/ _jsx(PropertyOverrides, {
                    ...
                    children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                        children: /*#__PURE__*/ _jsx(Container, {
                            className: "framer-117ms87-container hidden-72rtr7 hidden-1tai7yd",
                            "data-framer-name": "Navbar Mobile",
                            layoutScroll: true,
                            name: "Navbar Mobile",
                            nodeId: "pP8TOEFzj",
                            scopeId: "augiA20Il",
                            children: /*#__PURE__*/ _jsx(NavigationTopbar, {
                                height: "100%",
                                id: "pP8TOEFzj",
                                layoutId: "pP8TOEFzj",
                                name: "Navbar Mobile",
                    ...
                    children: [isDisplayed1() && /*#__PURE__*/ _jsx(PropertyOverrides, {
                        ...
                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                            height: 127,
                            width: `min(${componentViewport?.width||"100vw"} / 1.2, 1280px)`,
                            y: (componentViewport ? .y || 0) + 0 + 0 + 0 + 0,
                            children: /*#__PURE__*/ _jsx(Container, {
                                className: "framer-av2csc-container hidden-180ph05 hidden-xp04m8",
                        ...
                        children: /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [ /*#__PURE__*/ _jsx("div", {
                                    ...
                                    children: [ /*#__PURE__*/ _jsx(ResolveLinks, {
                                        ...
                                        children: resolvedLinks => /*#__PURE__*/ _jsx(PropertyOverrides, {
                                            ...
                                            overrides: {
                                                ...
                                                XWGQJU3bM: {
                                                    y: (componentViewport ? .y || 0) + 0 + 0 + 0 + 0 + 107 + 0 + 0 + 0 + 0 + 0 + 0
                                                }
                                            },
                                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                                height: 36,
                                                y: (componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 87 + 0 + 0 + 0 + 0,
                                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                    ...
                                                    children: /*#__PURE__*/ _jsx(PropertyOverrides, {
                                                        ...
                                                        overrides: {
                                                            jeCnrh3kk: {
                                                                meANpYlOk: resolvedLinks[1]
                                                            },
                                                            Q1XUigOVv: {
                                                                meANpYlOk: resolvedLinks[3],
                                                                variant: "UdidXiQq9"
                                                            },
                                                            XWGQJU3bM: {
                                                                meANpYlOk: resolvedLinks[2]
                                                            }
                                                        },
                                                        children: /*#__PURE__*/ _jsx(PillPill, {
                                                            height: "100%",
                                                            id: "t0oLs4C68",
                                                            layoutId: "t0oLs4C68",
                                                            meANpYlOk: resolvedLinks[0],
                                                            qS01XMJr8: "Learn About Guild Acadamy",
                                                            variant: "OIFIDN6of",
                                                            width: "100%"
                                                        })
                                                    })
                                        ...
                                        children: [ /*#__PURE__*/ _jsx(PropertyOverrides, {
                                                    ...
                                                    children: /*#__PURE__*/ _jsx(React.Fragment, {
                                                        children: /*#__PURE__*/ _jsx("h1", {
                                                            ...
                                                            children: /*#__PURE__*/ _jsx("span", {
                                                                "data-text-fill": "true",
                                                                style: {
                                                                    backgroundImage: "radial-gradient(92% 75% at 18.2% 90.5%, var(--token-2eaa7db8-96fe-4551-a9de-deb102762740, rgb(38, 38, 38)) 0%, var(--token-9302ad30-1055-4f54-8c25-a5a6efa02faf, rgb(89, 89, 89)) 100%)"
                                                                },
                                                                children: "Full-Stack Security for Web3 Products"
                                                            })
                                                        })
                                                    }),
                                            ...
                                            children: /*#__PURE__*/ _jsx(RichTextWithFX, {
                                                ...
                                                "data-framer-name": "A security-first alternative to Okta",
                                                fonts: ["Inter"],
                                            ...
                                            children: /*#__PURE__*/ _jsx(PropertyOverrides, {
                                                        ...
                                                        children: /*#__PURE__*/ _jsx(React.Fragment, {
                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                style: {
                                                                    ...
                                                                    "--framer-text-alignment": "left",
                                                                    "--framer-text-color": "var(--token-a2dcd121-2c82-4bf9-a79c-151a2036ba02, rgb(10, 11, 10))"
                                                                },
                                                                children: "Guild Audit secures decentralized systems from smart contracts to the infrastructure they run on. We provide end-to-end protection through blockchain security reviews, penetration testing, and hands-on cybersecurity training.  We help teams ship with confidence, defend against evolving threats, and build products that last."
                                                            })
                                                        }),
                                                ...
                                                children: /*#__PURE__*/ _jsx(RichTextWithFX, {
                                                    ...
                                                    "data-framer-name": "We are building a platform for better security in workforce identity and access management. Join as an early design partner and make your mark on the future of identity.",
                                                    fonts: ["Inter"],
                                                    verticalAlignment: "top",
                                                    withExternalLayout: true
                                                })
                                            ...
                                            children: /*#__PURE__*/ _jsx(ResolveLinks, {
                                                ...
                                                children: resolvedLinks1 => /*#__PURE__*/ _jsx(PropertyOverrides, {
                                                    ...
                                                    overrides: {
                                                        Q1XUigOVv: {
                                                            width: `min(min(${componentViewport?.width||"100vw"}, 1280px) - 32px, 1280px)`,
                                                            y: undefined
                                                        },
                                                        XWGQJU3bM: {
                                                            y: (componentViewport ? .y || 0) + 0 + 0 + 0 + 0 + 107 + 0 + 0 + 0 + 0 + 0 + 60 + 0 + 303 + 0
                                                        }
                                                    },
                                                    children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                                        height: 51,
                                                        y: (componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 87 + 0 + 0 + 0 + 60 + 0 + 303 + 0,
                                                        children: /*#__PURE__*/ _jsx(Container, {
                                                            className: "framer-1j1qadg-container",
                                                            nodeId: "pBxhmiDzF",
                                                            scopeId: "augiA20Il",
                                                            children: /*#__PURE__*/ _jsx(PropertyOverrides, {
                                                                breakpoint: baseVariant,
                                                                overrides: {
                                                                    jeCnrh3kk: {
                                                                        URgOW2Lv2: resolvedLinks1[1]
                                                                    },
                                                                    Q1XUigOVv: {
                                                                        style: {
                                                                            width: "100%"
                                                                        },
                                                                        URgOW2Lv2: resolvedLinks1[3]
                                                                    },
                                                                    XWGQJU3bM: {
                                                                        URgOW2Lv2: resolvedLinks1[2]
                                                                    }
                                                                },
                                                                children: /*#__PURE__*/ _jsx(ButtonGlowStroke, {
                                                                    height: "100%",
                                                                    id: "pBxhmiDzF",
                                                                    layoutId: "pBxhmiDzF",
                                                                    ofLqZhEO8: "Explore our services",
                                                                    URgOW2Lv2: resolvedLinks1[0],
                                                                    variant: "ZIp8JIAKN",
                                                                    width: "100%"
                                                                })
                                                            })
                                ...
                                className: "framer-v5ef1j hidden-180ph05 hidden-xp04m8",
                                ...
                                children: [ /*#__PURE__*/ _jsxs("div", {
                                    ...
                                    children: [ /*#__PURE__*/ _jsx(SVG, {
                                        ...
                                        opacity: 1,
                                        svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 772 397"><g transform="translate(-13.553 0)"><path d="M 0 177.348 C 0 177.348 55.298 203.923 63.43 207.72 C 71.562 211.516 82.947 210.432 91.079 209.889 C 99.211 209.347 215.228 179.518 253.719 149.146 C 292.211 118.775 392.506 35.253 453.225 20.609 C 513.944 5.966 612.612 0 612.612 0 L 786.096 0" fill="transparent" stroke-width="3.25" stroke="var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))" stroke-miterlimit="10"></path></g><g transform="translate(-11.927 99.244)"><path d="M 0 92.205 C 0 92.205 15.18 81.9 29.817 81.358 C 44.455 80.816 59.093 88.409 67.225 92.205 C 75.357 96.001 89.452 104.137 97.584 103.594 C 105.716 103.052 200.048 84.612 253.719 71.596 C 307.39 58.579 390.337 18.988 460.815 9.225 C 531.292 -0.537 609.36 0.005 609.36 0.005 L 784.469 0.005" fill="transparent" stroke-width="3.25" stroke="var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))" stroke-miterlimit="10"></path></g><g transform="translate(-13.553 190.185)"><path d="M 0 17.535 C 0 17.535 21.143 2.892 46.624 0.722 C 72.104 -1.447 119.27 1.807 141.497 3.434 C 163.725 5.061 168.062 6.688 181.615 7.231 C 195.169 7.773 612.07 7.773 612.07 7.773 L 790.433 7.773" fill="transparent" stroke-width="3.25" stroke="var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))" stroke-miterlimit="10"></path></g><g transform="translate(-10.301 187.653)"><path d="M 0 0 C 0 0 15.722 16.291 30.36 21.152 C 44.997 26.012 59.635 20.088 67.767 16.291 C 75.899 12.495 117.101 7.593 125.233 8.135 C 133.365 8.678 201.132 15.728 250.466 41.219 C 299.801 66.709 389.253 93.284 459.73 103.046 C 530.208 112.809 609.902 108.491 609.902 108.491 L 785.011 108.491" fill="transparent" stroke-width="3.25" stroke="var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))" stroke-miterlimit="10"></path></g><g transform="translate(-13.553 180.466)"><path d="M 0 39.213 C 0 39.213 55.298 12.638 63.43 8.841 C 71.562 5.045 80.236 -0.984 97.042 0.137 C 113.848 1.257 215.228 37.044 253.719 67.415 C 292.211 97.787 392.506 181.309 453.225 195.952 C 513.944 210.595 612.612 216.561 612.612 216.561 L 788.264 216.561" fill="transparent" stroke-width="3.25" stroke="var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))" stroke-miterlimit="10"></path></g><g><defs><linearGradient id="idss10016008766_11g-872248346" x1="0" x2="1" y1="0.4975124378109453" y2="0.5024875621890547"><stop offset="0" stop-color="rgba(11,12,11,0)" stop-opacity="0"></stop><stop offset="1" stop-color="rgb(11,12,11)" stop-opacity="1"></stop></linearGradient></defs><path d="M 484.669 414.355 L 484.669 -9.762 L 772 -9.762 L 772 414.355 Z" fill="url(#idss10016008766_11g-872248346)"></path></g></svg>',
                                        ...
                                        background: {
                                            ...
                                            intrinsicWidth: 464,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + 366 - 433),
                                            pixelHeight: 832,
                                            pixelWidth: 994,
                                            sizes: "108px",
                                            src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                                            srcSet: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832 512w,https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?width=994&height=832 994w"
                                        },
                                        ...
                                        background: {
                                            ...
                                            intrinsicHeight: 388.8,
                                            intrinsicWidth: 464,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + 366 - 148.1483),
                                            pixelHeight: 832,
                                            pixelWidth: 994,
                                            sizes: "140px",
                                            src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                                        ...
                                        background: {
                                            ...
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + -70),
                                            pixelHeight: 1472,
                                            pixelWidth: 1472,
                                            sizes: "186px",
                                            src: "https://framerusercontent.com/images/fKNDFCXL3wXoXazxoouVHn3Fgs.png?scale-down-to=1024&width=1472&height=1472",
                                            srcSet: "https://framerusercontent.com/images/fKNDFCXL3wXoXazxoouVHn3Fgs.png?scale-down-to=512&width=1472&height=1472 512w,https://framerusercontent.com/images/fKNDFCXL3wXoXazxoouVHn3Fgs.png?scale-down-to=1024&width=1472&height=1472 1024w,https://framerusercontent.com/images/fKNDFCXL3wXoXazxoouVHn3Fgs.png?width=1472&height=1472 1472w"
                                        },
                                        ...
                                        background: {
                                            ...
                                            intrinsicHeight: 864.8,
                                            intrinsicWidth: 864.8,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + 366 - 184),
                                            pixelHeight: 1472,
                                            pixelWidth: 1472,
                                            sizes: "188px",
                                            src: "https://framerusercontent.com/images/lSXeKVPa3y517m4Jc2eT3cbZd8.png?scale-down-to=1024&width=1472&height=1472",
                                            srcSet: "https://framerusercontent.com/images/lSXeKVPa3y517m4Jc2eT3cbZd8.png?scale-down-to=512&width=1472&height=1472 512w,https://framerusercontent.com/images/lSXeKVPa3y517m4Jc2eT3cbZd8.png?scale-down-to=1024&width=1472&height=1472 1024w,https://framerusercontent.com/images/lSXeKVPa3y517m4Jc2eT3cbZd8.png?width=1472&height=1472 1472w"
                                        },
                                        ...
                                        background: {
                                            ...
                                            intrinsicHeight: 864.8,
                                            intrinsicWidth: 864.8,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + 21),
                                            pixelHeight: 1081,
                                            pixelWidth: 1081,
                                            sizes: "126px",
                                            src: "https://framerusercontent.com/images/yUKACL7nBv7YVqeRYcdjpcYc2OM.png?scale-down-to=1024&width=1081&height=1081",
                                            srcSet: "https://framerusercontent.com/images/yUKACL7nBv7YVqeRYcdjpcYc2OM.png?scale-down-to=512&width=1081&height=1081 512w,https://framerusercontent.com/images/yUKACL7nBv7YVqeRYcdjpcYc2OM.png?scale-down-to=1024&width=1081&height=1081 1024w,https://framerusercontent.com/images/yUKACL7nBv7YVqeRYcdjpcYc2OM.png?width=1081&height=1081 1081w"
                                        },
                                        ...
                                        background: {
                                            ...
                                            intrinsicHeight: 864.8,
                                            intrinsicWidth: 864.8,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + -40),
                                            pixelHeight: 1081,
                                            pixelWidth: 1081,
                                            sizes: "140px",
                                            src: "https://framerusercontent.com/images/Hhbvt6HEF4CgZ9WnKxkyeWMOmY.png?scale-down-to=1024&width=1081&height=1081",
                                            srcSet: "https://framerusercontent.com/images/Hhbvt6HEF4CgZ9WnKxkyeWMOmY.png?scale-down-to=512&width=1081&height=1081 512w,https://framerusercontent.com/images/Hhbvt6HEF4CgZ9WnKxkyeWMOmY.png?scale-down-to=1024&width=1081&height=1081 1024w,https://framerusercontent.com/images/Hhbvt6HEF4CgZ9WnKxkyeWMOmY.png?width=1081&height=1081 1081w"
                                        },
                                        ...
                                        background: {
                                            ...
                                            intrinsicHeight: 864.8,
                                            intrinsicWidth: 864.8,
                                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 111 + 366 - 224),
                                            pixelHeight: 1081,
                                            pixelWidth: 1081,
                                            sizes: "133px",
                                            src: "https://framerusercontent.com/images/9UHpJk0ZYlKCnENfUccmYW9NJDw.png?scale-down-to=1024&width=1081&height=1081",
                                            srcSet: "https://framerusercontent.com/images/9UHpJk0ZYlKCnENfUccmYW9NJDw.png?scale-down-to=512&width=1081&height=1081 512w,https://framerusercontent.com/images/9UHpJk0ZYlKCnENfUccmYW9NJDw.png?scale-down-to=1024&width=1081&height=1081 1024w,https://framerusercontent.com/images/9UHpJk0ZYlKCnENfUccmYW9NJDw.png?width=1081&height=1081 1081w"
                                        },
                                    ...
                                    background: {
                                        ...
                                        intrinsicHeight: 864.8,
                                        intrinsicWidth: 864.8,
                                        loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 0 + 0 + 127 + 8 + 0 + 588 - 179),
                                        pixelHeight: 1081,
                                        pixelWidth: 1081,
                                        sizes: "126px",
                                        src: "https://framerusercontent.com/images/yUKACL7nBv7YVqeRYcdjpcYc2OM.png?scale-down-to=1024&width=1081&height=1081",
                    ...
                    children: [ /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                        children: /*#__PURE__*/ _jsx(ContainerWithOptimizedAppearEffect, {
                            ...
                            children: /*#__PURE__*/ _jsx(Ticker, {
                                ...
                                slots: [ /*#__PURE__*/ _jsx(SVG, {
                                    className: "framer-rlkxvq",
                                    ...
                                    background: {
                                        ...
                                        pixelWidth: 1024,
                                        sizes: "84px",
                                        src: "https://framerusercontent.com/images/eZHW23kjHESZoFKGsSWReV4.svg?width=1024&height=1024",
                                        srcSet: "https://framerusercontent.com/images/eZHW23kjHESZoFKGsSWReV4.svg?scale-down-to=512&width=1024&height=1024 512w,https://framerusercontent.com/images/eZHW23kjHESZoFKGsSWReV4.svg?width=1024&height=1024 1024w"
                                    },
                                    className: "framer-1fi0lp3"
                                }), /*#__PURE__*/ _jsx(Image, {
                                    background: {
                                        alt: "",
                                        fit: "fill",
                                        ...
                                        pixelWidth: 443,
                                        sizes: "207px",
                                        src: "https://framerusercontent.com/images/xqGfvt2T8zMy1YJVu0H65wWVU.svg?width=443&height=136"
                                    },
                                    className: "framer-1dlzcvs",
                                    "data-framer-name": "pody"
                                }), /*#__PURE__*/ _jsx(Image, {
                                    background: {
                                        alt: "",
                                        fit: "fill",
                                        ...
                                        pixelWidth: 114,
                                        sizes: "391px",
                                        src: "https://framerusercontent.com/images/kQrpb7JqO6ytjw74pKsU6FSybAg.svg?width=114&height=25"
                                    },
                                    className: "framer-ib2qfr",
                                    "data-framer-name": "coinsafe"
                                })],
                                speed: 30,
                                style: {
                                    height: "100%",
                                ...
                                children: [ /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                    children: /*#__PURE__*/ _jsx(Container, {
                                        ...
                                        children: /*#__PURE__*/ _jsx(NumberCounter, {
                                            ...
                                            fontColor: "var(--token-a2dcd121-2c82-4bf9-a79c-151a2036ba02, rgb(10, 11, 10))",
                                            fontSize: 28,
                                            height: "100%",
                                            id: "hmC9rv1mJ",
                                            layoutId: "hmC9rv1mJ",
                                ...
                                children: /*#__PURE__*/ _jsx(React.Fragment, {
                                    children: /*#__PURE__*/ _jsx("p", {
                                        style: {
                                            ...
                                            "--framer-text-color": "var(--token-69a0ec5c-da85-4a5a-a0c3-c41a92df0364, rgb(153, 153, 153))"
                                        },
                    ...
                    children: [ /*#__PURE__*/ _jsx(RichText, {
                        ...
                        children: /*#__PURE__*/ _jsx(React.Fragment, {
                            children: /*#__PURE__*/ _jsx("p", {
                                style: {
                                    ...
                                    "--framer-text-alignment": "center",
                                    "--framer-text-color": "var(--token-7049cce7-715e-45a0-a41e-932274474306, rgb(9, 227, 8))"
                                },
                        ...
                        children: /*#__PURE__*/ _jsx(React.Fragment, {
                            children: /*#__PURE__*/ _jsx("p", {
                                ...
                                children: "Providing auditing for the following blockchains and more."
                            })
                        }),
                        ...
                        children: [ /*#__PURE__*/ _jsx(Image, {
                            background: {
                                ...
                                intrinsicHeight: 272,
                                intrinsicWidth: 272,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1206.5 + 265 + 1),
                                pixelHeight: 272,
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/jQ9MeNPwRw7aziif3oefg0VA6A.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/L1Dy4BopIy60MRVYrYgqyOrRVK4.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                intrinsicWidth: 520,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1206.5 + 265 + 5),
                                pixelHeight: 651,
                                pixelWidth: 650,
                                sizes: "72px",
                                src: "https://framerusercontent.com/images/QESvCvsgp3izcFPOqGE6s1aZGDI.png?width=650&height=651",
                                srcSet: "https://framerusercontent.com/images/QESvCvsgp3izcFPOqGE6s1aZGDI.png?width=650&height=651 650w"
                            },
                            ...
                            background: {
                                ...
                                intrinsicHeight: 520.8,
                                intrinsicWidth: 520,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1206.5 + 265 + 4.9446),
                                pixelHeight: 651,
                                pixelWidth: 650,
                                sizes: "72px",
                                src: "https://framerusercontent.com/images/UVs4xlHerWCNnm9n6VjTZKMeHQ.png?width=650&height=651",
                                srcSet: "https://framerusercontent.com/images/UVs4xlHerWCNnm9n6VjTZKMeHQ.png?width=650&height=651 650w"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/n6vP8ESbJs8QizubSQFxVv3anVs.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/gzEYgwRactEuvufBq5r5AzUOc.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/gV79M4V3cgwbCxt68MxnYYeT7g.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/9S7ZAVZVUXTKX6hhI5wvdPNw.png?width=272&height=272"
                            },
                            ...
                            background: {
                                ...
                                pixelWidth: 272,
                                sizes: "80px",
                                src: "https://framerusercontent.com/images/yaMy9ruL3fA6l4408XRtuU4HKRE.png?width=272&height=272"
                            },
                            className: "framer-1iup5ag"
                        })]
                    }), isDisplayed4() && /*#__PURE__*/ _jsxs("div", {
                        className: "framer-14q7ajt hidden-72rtr7 hidden-1tai7yd",
                        children: [ /*#__PURE__*/ _jsx(PropertyOverrides, {
                            breakpoint: baseVariant,
                            overrides: {
                                XWGQJU3bM: {
                                    background: {
                                        ...
                                        intrinsicHeight: 272,
                                        intrinsicWidth: 272,
                                        loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 940.5 + 251 + 0 + 0),
                                        pixelHeight: 272,
                                        pixelWidth: 272,
                                        src: "https://framerusercontent.com/images/jQ9MeNPwRw7aziif3oefg0VA6A.png?width=272&height=272"
                                    }
                            ...
                            overrides: {
                                XWGQJU3bM: {
                                    background: {
                                        ...
                                        pixelHeight: 272,
                                        pixelWidth: 272,
                                        src: "https://framerusercontent.com/images/d0tRRGoK8uysnjgnZGdjNw5ipAc.png?width=272&height=272"
                                    }
                                }
                            },
                            children: /*#__PURE__*/ _jsx(Image, {
                            ...
                            overrides: {
                                XWGQJU3bM: {
                                    background: {
                                        ...
                                        pixelHeight: 272,
                                        pixelWidth: 272,
                                        src: "https://framerusercontent.com/images/fwINI0g62WGdCyj5m0teA0A0.png?width=272&height=272"
                                    }
                                }
                            },
                            children: /*#__PURE__*/ _jsx(Image, {
                ...
                }), isDisplayed5() && /*#__PURE__*/ _jsxs("div", {
                    className: "framer-1quyz1w hidden-72rtr7 hidden-1tai7yd hidden-180ph05",
                        ...
                        children: [ /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [ /*#__PURE__*/ _jsx(RichText, {
                                ...
                                children: /*#__PURE__*/ _jsx(React.Fragment, {
                                    children: /*#__PURE__*/ _jsx("h2", {
                                        style: {
                                            "--font-selector": "RlM7UGx1cyBKYWthcnRhIFNhbnMtcmVndWxhcg==",
                                            "--framer-font-family": '"Plus Jakarta Sans", "Plus Jakarta Sans Placeholder", sans-serif',
                                            "--framer-font-size": "15px",
                                ...
                                children: /*#__PURE__*/ _jsx(React.Fragment, {
                                    children: /*#__PURE__*/ _jsx("h2", {
                                        style: {
                                            "--font-selector": "RlM7UGx1cyBKYWthcnRhIFNhbnMtbWVkaXVt",
                                            "--framer-font-family": '"Plus Jakarta Sans", "Plus Jakarta Sans Placeholder", sans-serif',
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 651,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/sqrh7j4vJl8KzqLRoXAOgQvCxQ.png?width=651&height=651",
                                                srcSet: "https://framerusercontent.com/images/sqrh7j4vJl8KzqLRoXAOgQvCxQ.png?scale-down-to=512&width=651&height=651 512w,https://framerusercontent.com/images/sqrh7j4vJl8KzqLRoXAOgQvCxQ.png?width=651&height=651 651w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 650,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/MRa04MH6P0TWHfzr7Dr0Hk8oeg.png?width=650&height=651",
                                                srcSet: "https://framerusercontent.com/images/MRa04MH6P0TWHfzr7Dr0Hk8oeg.png?width=650&height=651 650w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 651,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/MvQ5GOHW6DebjXYSDOrf6Gq6lM.png?width=651&height=651",
                                                srcSet: "https://framerusercontent.com/images/MvQ5GOHW6DebjXYSDOrf6Gq6lM.png?scale-down-to=512&width=651&height=651 512w,https://framerusercontent.com/images/MvQ5GOHW6DebjXYSDOrf6Gq6lM.png?width=651&height=651 651w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 650,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/KItj9fQ2qxzJTPHVUJZsLHVAuyE.png?width=650&height=651",
                                                srcSet: "https://framerusercontent.com/images/KItj9fQ2qxzJTPHVUJZsLHVAuyE.png?width=650&height=651 650w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                positionY: "center",
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/L0cDW2FgeZnTvkAp0jXy1p5WM.png?width=582&height=651",
                                                srcSet: "https://framerusercontent.com/images/L0cDW2FgeZnTvkAp0jXy1p5WM.png?width=582&height=651 582w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 651,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/bFUQLGtXxFvemL3EwEMla4KpImw.png?width=651&height=651",
                                                srcSet: "https://framerusercontent.com/images/bFUQLGtXxFvemL3EwEMla4KpImw.png?scale-down-to=512&width=651&height=651 512w,https://framerusercontent.com/images/bFUQLGtXxFvemL3EwEMla4KpImw.png?width=651&height=651 651w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 651,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/DOdBid3SZ1tt9qNMlotY2Q5Am4.png?width=651&height=651",
                                                srcSet: "https://framerusercontent.com/images/DOdBid3SZ1tt9qNMlotY2Q5Am4.png?scale-down-to=512&width=651&height=651 512w,https://framerusercontent.com/images/DOdBid3SZ1tt9qNMlotY2Q5Am4.png?width=651&height=651 651w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                                    ...
                                    overrides: {
                                        Q1XUigOVv: {
                                            background: {
                                                ...
                                                pixelWidth: 651,
                                                sizes: "65px",
                                                src: "https://framerusercontent.com/images/m5nGxPuBjPGiL0EcU8RqPD5A71I.png?width=651&height=651",
                                                srcSet: "https://framerusercontent.com/images/m5nGxPuBjPGiL0EcU8RqPD5A71I.png?scale-down-to=512&width=651&height=651 512w,https://framerusercontent.com/images/m5nGxPuBjPGiL0EcU8RqPD5A71I.png?width=651&height=651 651w"
                                            }
                                        }
                                    },
                                    children: /*#__PURE__*/ _jsx(Image, {
                    ...
                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(PropertyOverrides, {
                        ...
                        overrides: {
                            XWGQJU3bM: {
                                background: {
                                    ...
                                    intrinsicHeight: 388.8,
                                    intrinsicWidth: 464,
                                    loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1318.5 + -87.9626),
                                    pixelHeight: 832,
                                    pixelWidth: 994,
                                    sizes: "170px",
                                    src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                        ...
                        children: /*#__PURE__*/ _jsx(ImageWithFX, {
                            ...
                            background: {
                                ...
                                intrinsicHeight: 388.8,
                                intrinsicWidth: 464,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1655.5 + -37.9734),
                                pixelHeight: 832,
                                pixelWidth: 994,
                                sizes: "251px",
                                src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                        ...
                        overrides: {
                            jeCnrh3kk: {
                                background: {
                                    ...
                                    intrinsicHeight: 388.8,
                                    intrinsicWidth: 464,
                                    loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1655.5 + 1255 - 155.0092),
                                    pixelHeight: 832,
                                    pixelWidth: 994,
                                    sizes: "151px",
                                    src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                            ...
                            XWGQJU3bM: {
                                background: {
                                    ...
                                    intrinsicHeight: 388.8,
                                    intrinsicWidth: 464,
                                    loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1318.5 + 870.0326),
                                    pixelHeight: 832,
                                    pixelWidth: 994,
                                    sizes: "151px",
                                    src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                        ...
                        children: /*#__PURE__*/ _jsx(ImageWithFX, {
                            ...
                            background: {
                                ...
                                intrinsicHeight: 388.8,
                                intrinsicWidth: 464,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 1655.5 + 1334 - 155.0092),
                                pixelHeight: 832,
                                pixelWidth: 994,
                                sizes: "151px",
                                src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                                ...
                                Q1XUigOVv: {
                                    children: /*#__PURE__*/ _jsx(React.Fragment, {
                                        children: /*#__PURE__*/ _jsx("h2", {
                                            ...
                                            children: "Specializing in providing top-notch blockchain security solutions."
                                        })
                                    })
                                }
                            },
                    ...
                    }), isDisplayed6() && /*#__PURE__*/ _jsxs("div", {
                        className: "framer-17ve921 hidden-1tai7yd hidden-180ph05 hidden-xp04m8",
                        "data-framer-name": "Container",
                        children: [ /*#__PURE__*/ _jsx(motion.div, {
                            ...
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                height: 516,
                                width: "306px",
                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 31 + 0 + 0 + 0,
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    __framer__animate: {
                                    ...
                                    __perspectiveFX: false,
                                    __targetOpacity: 1,
                                    className: "framer-pnykgl-container",
                                    nodeId: "LjGEMo6pZ",
                                    rendersWithMotion: true,
                                    scopeId: "augiA20Il",
                                    children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                        height: "100%",
                                        I0KtDm67s: "We thoroughly test your web applications and APIs to identify security weaknesses before attackers do. Our approach looks at how your system works in the real world, from login flows and data handling to business logic and integrations.",
                                        id: "LjGEMo6pZ",
                                        jxpw6yvEh: "Web App Penetration Testing",
                                        layoutId: "LjGEMo6pZ",
                                        style: {
                                            height: "100%",
                                            width: "100%"
                            ...
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                ...
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    ...
                                    __perspectiveFX: false,
                                    __targetOpacity: 1,
                                    className: "framer-1bnxnjp-container",
                                    nodeId: "WQ6Y2EGjX",
                                    rendersWithMotion: true,
                                    scopeId: "augiA20Il",
                                    children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                        height: "100%",
                                        I0KtDm67s: "We offer dedicated smart contract security reviews tailored to your product’s architecture, timeline, and development workflow. We work closely with your team to understand how the system is intended to function, identify vulnerabilities, and provide practical fixes you can apply immediately.",
                                        id: "WQ6Y2EGjX",
                                        jxpw6yvEh: "Private Audit",
                                        layoutId: "WQ6Y2EGjX",
                                        style: {
                                            height: "100%",
                                            width: "100%"
                            ...
                            className: "framer-hm2k0l",
                            "data-border": true,
                            "data-framer-name": "Lest 01",
                            whileTap: animation10,
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                height: 511,
                                width: `max(max((min(min(${componentViewport?.width||"100vw"} / 1.2, 1280px) - 64px, 1200.04px) - 189px) / 4, 50px), 300px)`,
                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 31 + 0 + 0 + 0,
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    __framer__animate: {
                                        transition: transition14
                                    ...
                                    __perspectiveFX: false,
                                    __targetOpacity: 1,
                                    className: "framer-ifo4ea-container",
                                    nodeId: "AkSQh_XEw",
                                    rendersWithMotion: true,
                                    scopeId: "augiA20Il",
                                    children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                        height: "100%",
                                        I0KtDm67s: "End-to-end testing of your web, backend, and blockchain layers to uncover real attack paths and strengthen your product’s security.",
                                        id: "AkSQh_XEw",
                                        jxpw6yvEh: "Full Stack Penetration Testing",
                                        layoutId: "AkSQh_XEw",
                                        style: {
                                            height: "100%",
                                            width: "100%"
                            ...
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                ...
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    ...
                                    __perspectiveFX: false,
                                    __targetOpacity: 1,
                                    className: "framer-1m31npg-container",
                                    nodeId: "iqnVKE85a",
                                    rendersWithMotion: true,
                                    scopeId: "augiA20Il",
                                    children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                        height: "100%",
                                        I0KtDm67s: "We build custom fuzzing suites for our clients that simulate millions of randomized and targeted transactions in the cloud via Guild Server, uncovering critical contract flaws and unexpected edge cases before attackers do.\n",
                                        id: "iqnVKE85a",
                                        jxpw6yvEh: "Fuzzing as a service",
                                        layoutId: "iqnVKE85a",
                                        style: {
                                            height: "100%",
                                            width: "100%"
                            ...
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                height: 505,
                                width: `max(max((min(min(${componentViewport?.width||"100vw"} / 1.2, 1280px) - 64px, 1200.04px) - 189px) / 4, 50px), 300px)`,
                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 31 + 582 + 0 + 0,
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    __framer__animate: {
                                        transition: transition14
                                    },
                                    ...
                                    __perspectiveFX: false,
                                    __targetOpacity: 1,
                                    className: "framer-v5y587-container",
                                    nodeId: "NsJDjLSZh",
                                    rendersWithMotion: true,
                                    scopeId: "augiA20Il",
                                    children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                        height: "100%",
                                        I0KtDm67s: "We run hands-on bootcamps at Guild Academy, equipping developers and security researchers with the skills to secure Web3 products and grow in blockchain security. \n",
                                        id: "NsJDjLSZh",
                                        jxpw6yvEh: "Education",
                                        layoutId: "NsJDjLSZh",
                                        style: {
                    ...
                    }), isDisplayed7() && /*#__PURE__*/ _jsxs("div", {
                        className: "framer-8nj5qx hidden-72rtr7 hidden-180ph05 hidden-xp04m8",
                        "data-framer-name": "Container",
                        children: [ /*#__PURE__*/ _jsx(Overlay, {
                            dismissWithEsc: true,
                            enabled: isDisplayed8(),
                            children: overlay => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-1erp167",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "1erp167",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed8() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                            ...
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                ...
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1h100fc")} hidden-1tai7yd`,
                                                        "data-framer-portal-id": "1erp167",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "KDIlAvkCO"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-9auitt"),
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1ikjks3",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-44hs4q",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-d6jl8d",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                                    withExternalLayout: true
                                                                })
                                                            })
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1s3nvo"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1gcq60n",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                                                        ...
                                                                        children: "Our Web3 penetration testing engagements are designed to simulate real-world attacks against decentralized applications and blockchain infrastructure. We focus on identifying exploitable vulnerabilities across:"
                                                                    }), /*#__PURE__*/ _jsx("p", {
                                                                        className: "framer-styles-preset-k8yxrn",
                                                                        "data-styles-preset": "ferGDeq75",
                                                                        style: {
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                ...
                                                                                children: "Blockchain Infrastructure: Assessing node exposure, misconfigurations, RPC/API weaknesses, and risks in consensus or communication protocols."
                                                                            })
                                                                        }), /*#__PURE__*/ _jsxs("li", {
                                                                            children: [ /*#__PURE__*/ _jsx("p", {
                                                                                style: {
                                                                                ...
                                                                                children: "Decentralized Applications (dApps): Testing for client-side and backend issues, insecure Web3 integrations, wallet interaction flaws, authentication bypasses, and more."
                                                                            }), /*#__PURE__*/ _jsx("p", {
                                                                                style: {
                                                                                    "--framer-text-alignment": "left"
                                                                                },
                                                                                children: "After testing, all findings had been delivered in a detailed report that included risk ratings, proof-of-concept (PoC) examples, recommendations, and sufficient technical detail."
                                                                            })]
                                                                        })]
                                                                    })]
                                                                }),
                                                                className: "framer-8ofj6q",
                                                                fonts: ["Inter"],
                                                                verticalAlignment: "top",
                                                                withExternalLayout: true
                                                            })
                                        ...
                                        overrides: {
                                            jeCnrh3kk: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} / 1.2, 1280px) - 64px, 1200px) - 64px) / 3, 50px), 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 0 + 0 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 526,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-uo6tz2-container",
                                                nodeId: "MHIroEd4e",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            children: overlay1 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    ...
                                    children: [isDisplayed8() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                            ...
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                ...
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-b3pmqq")} hidden-1tai7yd`,
                                                        "data-framer-portal-id": "i3vdr1",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "Jf0Ahqbke"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-1if1c0n"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "i3vdr1",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-og8grk",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-2eri9h",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay1
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-4bjp2o",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-18q70nj"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1muluri",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                                                        ...
                                                                        children: "Our Smart Contract Auditing services are designed to help you secure your blockchain-based applications before they go live. We perform in-depth code reviews and vulnerability assessments tailored to your contract’s logic and platform."
                                                                    }), /*#__PURE__*/ _jsxs("p", {
                                                                        style: {
                                                                            "--framer-font-size": "24px",
                                                                            "--framer-text-alignment": "left",
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsx("br", {}), /*#__PURE__*/ _jsx("br", {}), /*#__PURE__*/ _jsx("br", {
                                                                            className: "trailing-break"
                                                                        })]
                                                                    }), /*#__PURE__*/ _jsxs("ul", {
                                                                        style: {
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsxs("li", {
                                                                            children: [ /*#__PURE__*/ _jsx("p", {
                                                                                children: "Our auditing process includes:"
                                                                            }), /*#__PURE__*/ _jsxs("p", {
                                                                            ...
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "Business Logic Validation"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "Security Best Practices Check"
                                                                            })
                                                                        })]
                                                                    }), /*#__PURE__*/ _jsxs("p", {
                                                                        style: {
                                                                        ...
                                                                        children: "After testing, all findings are delivered in a detailed report that includes risk ratings, proof-of-concept (PoC) examples, recommendations, and sufficient technical detail."
                                                                    })]
                                                                }),
                                                                className: "framer-1sy3vvo",
                                                                fonts: ["Inter"],
                                                                verticalAlignment: "top",
                                                                withExternalLayout: true
                                                            })
                                        ...
                                        overrides: {
                                            jeCnrh3kk: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} / 1.2, 1280px) - 64px, 1200px) - 64px) / 3, 50px) / 1.04, 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 0 + 0 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-l5qj57-container",
                                                nodeId: "hdCvPQTWm",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                ...
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    ...
                                    children: [isDisplayed8() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                            ...
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                ...
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1yqudl9")} hidden-1tai7yd`,
                                                        "data-framer-portal-id": "1449j0v",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "a2BVIQHg_"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-awxle2"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "1449j0v",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-rovif2",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-1y7t8bf",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay2
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1edlytx",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-byj2dy"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1wa3ffs",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                                                        ...
                                                                        children: "Our comprehensive Web Application Penetration Testing service identifies vulnerabilities in your web applications before malicious actors can exploit them. We use a combination of automated tools and manual testing to discover:"
                                                                    }), /*#__PURE__*/ _jsxs("p", {
                                                                        style: {
                                                                            "--framer-font-size": "24px",
                                                                            "--framer-text-alignment": "left",
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "OWASP TOP 10 vulnerabilities"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "SQL Injection vulnerabilities"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "Cross-Site Scripting (XSS) weaknesses"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "Authentication flaws"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "Authorization bypass issues"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                                                                children: "API security problems"
                                                                            })
                                                                        }), /*#__PURE__*/ _jsx("li", {
                                                                            children: /*#__PURE__*/ _jsx("p", {
                                        ...
                                        overrides: {
                                            jeCnrh3kk: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} / 1.2, 1280px) - 64px, 1200px) - 64px) / 3, 50px), 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1655.5 + 0 + 131 + 0 + 558 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 463,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-vidpj7-container",
                                                nodeId: "P0GISdp64",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                    ...
                                    children: [isDisplayed8() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                            ...
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                ...
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-ju1chp")} hidden-1tai7yd`,
                                                        "data-framer-portal-id": "murt2q",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "zazaTc_QL"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-17wyyei"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "murt2q",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-642ihm",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-7dlo5z",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay3
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1um3tcc",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1ybsfuz"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1upm32p",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-11qrvws-container",
                                                nodeId: "KCvSZ0Rqx",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                    ...
                                    children: [isDisplayed8() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                            ...
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                ...
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1j1s821")} hidden-1tai7yd`,
                                                        "data-framer-portal-id": "1an9h9",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "UTNBuWr7b"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-1kmk614"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "1an9h9",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-d3sbu2",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-dfs4oe",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay4
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1q7ldri",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1idxyfk"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-fhonee",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsxs("p", {
                                                                        ...
                                                                        children: ["Our comprehensive Web Application Penetration Testing service identifies vulnerabilities in your web applications before malicious actors can exploit them. We use a combination of automated tools and manual testing to discover:", /*#__PURE__*/ _jsx("br", {}), /*#__PURE__*/ _jsx("br", {
                                                                            className: "trailing-break"
                                                                        })]
                                                                    }), /*#__PURE__*/ _jsxs("ul", {
                                                                        style: {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-he8xwy-container",
                                                nodeId: "qe1v7dLL_",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                        ...
                        className: "framer-17jovs7 hidden-72rtr7 hidden-1tai7yd hidden-xp04m8",
                        "data-framer-name": "Container",
                        children: [ /*#__PURE__*/ _jsx(Overlay, {
                            dismissWithEsc: true,
                            enabled: isDisplayed3(),
                            children: overlay5 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-158s6tn",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "158s6tn",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed3() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay5.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "158s6tn",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-g7qm0x")} hidden-180ph05`,
                                                        "data-framer-portal-id": "158s6tn",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "GedZbCujg"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-d70vma"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "158s6tn",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1hpmjv7",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-cjhwy4",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay5
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-qtyv4h",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-6pb3kq"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-oej0dq",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        overrides: {
                                            XWGQJU3bM: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} * 0.95, 1280px) - 64px, 1200px) - 24px) / 2, 50px), 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1318.5 + 0 + 141 + 0 + 0 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 517,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-evi2uq-container",
                                                nodeId: "FnXDHSyVd",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed3(),
                            children: overlay6 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-ynnrj",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "ynnrj",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed3() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay6.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "ynnrj",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-k05ova")} hidden-180ph05`,
                                                        "data-framer-portal-id": "ynnrj",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "HEnLmUtKs"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-4md5t3"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "ynnrj",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-sp1i4e",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-lwssnz",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay6
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1cgldwt",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1agcd6m"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-12itxsf",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-y00tt9-container",
                                                nodeId: "P7FOdosYb",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed3(),
                            children: overlay7 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-rti5h1",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "rti5h1",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed3() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay7.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "rti5h1",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-ga09d8")} hidden-180ph05`,
                                                        "data-framer-portal-id": "rti5h1",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "qeLAiXY8o"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-1i48b93"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "rti5h1",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-12lha19",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-1525xdu",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay7
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1ej7byw",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-5vvf03"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1c1nlt5",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        overrides: {
                                            XWGQJU3bM: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} * 0.95, 1280px) - 64px, 1200px) - 24px) / 2, 50px), 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1318.5 + 0 + 141 + 0 + 591 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 479,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-monuun-container",
                                                nodeId: "XyqLVqRBs",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed3(),
                            children: overlay8 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-1xil1if",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "1xil1if",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed3() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay8.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "1xil1if",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1ecdkeg")} hidden-180ph05`,
                                                        "data-framer-portal-id": "1xil1if",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "FJD6gEdpR"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-12nad2b"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "1xil1if",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-lz6jab",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-14u23qw",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay8
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-agmmrf",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1tsbi4w"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-13gen3i",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        overrides: {
                                            XWGQJU3bM: {
                                                width: `max(max((min(min(${componentViewport?.width||"100vw"} * 0.95, 1280px) - 64px, 1200px) - 24px) / 2, 50px), 300px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 1318.5 + 0 + 141 + 0 + 1182 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 567,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-1a2tpk0-container",
                                                nodeId: "FSeMRVs4C",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                                                    height: "100%",
                                                    I0KtDm67s: "Our fuzzing service intelligently bombaWe build custom fuzzing suites for our clients that simulate millions of randomized and targeted transactions in the cloud via Guild Server, uncovering critical contract flaws and unexpected edge cases before attackers do.\nrds inputs to find crashes, memory corruption, logic flips, and unexpected behavior before attackers do.",
                                                    id: "FSeMRVs4C",
                                                    jxpw6yvEh: "Fuzzing as a service ",
                                                    layoutId: "FSeMRVs4C",
                                                    style: {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed3(),
                            children: overlay9 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-1o6f7yl",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "1o6f7yl",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed3() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay9.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "1o6f7yl",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1nrruj9")} hidden-180ph05`,
                                                        "data-framer-portal-id": "1o6f7yl",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "HcoBhsAZi"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-1cg1hj4"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "1o6f7yl",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-p58b54",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-vb675d",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay9
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1fhaics",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-13yncjs"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1hsd482",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsx("br", {}), "After testing, all findings are delivered in a detailed report that includes risk ratings, proof-of-concept (PoC) examples, recommendations, and sufficient technical detail."]
                                                                    })]
                                                                }),
                                                                className: "framer-15ctgro",
                                                                fonts: ["Inter"],
                                                                verticalAlignment: "top",
                                                                withExternalLayout: true
                                                            })
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-hheqml-container",
                                                nodeId: "XeawhO1Rb",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                        ...
                        className: "framer-1tzbzly hidden-72rtr7 hidden-1tai7yd hidden-180ph05",
                        "data-framer-name": "Container",
                        children: [ /*#__PURE__*/ _jsx(Overlay, {
                            dismissWithEsc: true,
                            enabled: isDisplayed2(),
                            children: overlay10 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-mqt67n",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "mqt67n",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay10.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "mqt67n",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1vh7a2y")} hidden-xp04m8`,
                                                        "data-framer-portal-id": "mqt67n",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "NGKVv39kv"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-15zctwb"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "mqt67n",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1g4kg2s",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-v30s9e",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay10
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-14y3civ",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1o8ugw9"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-wchvvx",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        overrides: {
                                            Q1XUigOVv: {
                                                width: `max(min(min(${componentViewport?.width||"100vw"}, 1280px) - 32px, 1200px) - 40px, 300px)`
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 519,
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-1188ypm-container",
                                                nodeId: "rVA6hLd7k",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed2(),
                            children: overlay11 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-32qjfq",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "32qjfq",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay11.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "32qjfq",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1i1absw")} hidden-xp04m8`,
                                                        "data-framer-portal-id": "32qjfq",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "tuwvXCkZv"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-15elhha"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "32qjfq",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1vkuvue",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-qfsrpu",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay11
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-gqjh90",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-am45lx"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1y8u38w",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-1gaq0n5-container",
                                                nodeId: "Zq5hyJF5P",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed2(),
                            children: overlay12 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-qln1dk",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "qln1dk",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay12.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "qln1dk",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-1asgtwm")} hidden-xp04m8`,
                                                        "data-framer-portal-id": "qln1dk",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "NrVo_8RLu"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-9u7okj"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "qln1dk",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-thb99j",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-d4hz9o",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay12
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-17m0c6q",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-14euav8"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-60m3ng",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-1txnp0l-container",
                                                nodeId: "jZ3IWW0oi",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed2(),
                            children: overlay13 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-14xtu1x",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "14xtu1x",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay13.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "14xtu1x",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-39oadp")} hidden-xp04m8`,
                                                        "data-framer-portal-id": "14xtu1x",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "w9FSSmBbp"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-hdhl4y"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "14xtu1x",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-am1lwv",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-1t3x7pn",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay13
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-s9w34c",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-1wtspxr"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1axwptv",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-1ljrcta-container",
                                                nodeId: "vpcdHqleb",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                            ...
                            dismissWithEsc: true,
                            enabled: isDisplayed2(),
                            children: overlay14 => /*#__PURE__*/ _jsx(_Fragment, {
                                children: /*#__PURE__*/ _jsxs(motion.div, {
                                    className: "framer-jpvyd2",
                                    "data-border": true,
                                    "data-framer-name": "Lest 01",
                                    id: "jpvyd2",
                                    onTap: onTap3bnx0g({
                                    ...
                                    whileTap: animation10,
                                    children: [isDisplayed2() && /*#__PURE__*/ _jsx(AnimatePresence, {
                                        children: overlay14.visible && /*#__PURE__*/ _jsx(_Fragment, {
                                            children: /*#__PURE__*/ ReactDOM.createPortal( /*#__PURE__*/ _jsx(InjectSelectionStyle, {
                                                triggerId: "jpvyd2",
                                                children: /*#__PURE__*/ _jsxs(ResetOuterLinkContext, {
                                                    children: [ /*#__PURE__*/ _jsx(motion.div, {
                                                        ...
                                                        className: `${cx(scopingClassNames,"framer-nr8cxd")} hidden-xp04m8`,
                                                        "data-framer-portal-id": "jpvyd2",
                                                        exit: {
                                                            opacity: 0
                                                        },
                                                        initial: {
                                                    ...
                                                    }, "PRf1ijLbf"), /*#__PURE__*/ _jsxs(motion.div, {
                                                        animate: animation13,
                                                        className: cx(scopingClassNames, "framer-1g5rblz"),
                                                        "data-framer-name": "Modal",
                                                        "data-framer-portal-id": "jpvyd2",
                                                        exit: animation12,
                                                        initial: animation14,
                                                        ...
                                                        children: [ /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1ulm9iq",
                                                            children: /*#__PURE__*/ _jsx(motion.div, {
                                                                className: "framer-xshd1e",
                                                                "data-framer-name": "Close",
                                                                onTap: onTap1wnntms({
                                                                    overlay: overlay14
                                                                }),
                                                                children: /*#__PURE__*/ _jsx(SVG, {
                                                                    className: "framer-1bw8t5a",
                                                                    "data-framer-name": "Icon",
                                                                    opacity: 1,
                                                                    svg: '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20"><path d="M 10 1 C 14.971 1 19 5.029 19 10 C 19 14.971 14.971 19 10 19 C 5.029 19 1 14.971 1 10 C 1 5.029 5.029 1 10 1 Z M 6.464 12.121 C 6.074 12.512 6.074 13.145 6.464 13.536 C 6.855 13.926 7.488 13.926 7.879 13.536 L 10 11.414 L 12.121 13.536 C 12.512 13.926 13.145 13.926 13.536 13.536 C 13.926 13.145 13.926 12.512 13.536 12.121 L 11.414 10 L 13.536 7.879 C 13.926 7.488 13.926 6.855 13.536 6.464 C 13.145 6.074 12.512 6.074 12.121 6.464 L 10 8.586 L 7.879 6.464 C 7.488 6.074 6.855 6.074 6.464 6.464 C 6.074 6.855 6.074 7.488 6.464 7.879 L 8.586 10 Z" fill="#ffffff"></path></svg>',
                                                                    svgContentId: 9017341790,
                                                            ...
                                                            className: "framer-rrq234"
                                                        }), /*#__PURE__*/ _jsx("div", {
                                                            className: "framer-1dcb64d",
                                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                                __fromCanvasComponent: true,
                                                                children: /*#__PURE__*/ _jsxs(React.Fragment, {
                                                                    children: [ /*#__PURE__*/ _jsx("p", {
                                                                        ...
                                                                        children: [ /*#__PURE__*/ _jsx("li", {
                                                                            ...
                                                                            children: /*#__PURE__*/ _jsxs("p", {
                                                                                children: ["Business logic flaws", /*#__PURE__*/ _jsx("br", {}), /*#__PURE__*/ _jsx("br", {
                                                                                    className: "trailing-break"
                                                                                })]
                                                                            })
                                                                        })]
                                        ...
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                                ...
                                                __perspectiveFX: false,
                                                __targetOpacity: 1,
                                                className: "framer-tp6a9j-container",
                                                nodeId: "V6A94H9Rd",
                                                rendersWithMotion: true,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(CardsFeatureCard2, {
                    ...
                    children: [isDisplayed6() && /*#__PURE__*/ _jsx(ImageWithFX, {
                        __framer__loop: animation4,
                        __framer__loopEffectEnabled: true,
                        __framer__loopRepeatDelay: 0,
                        __framer__loopRepeatType: "mirror",
                        ...
                        background: {
                            ...
                            intrinsicHeight: 388.8,
                            intrinsicWidth: 464,
                            loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 2989.5 + 1079),
                            pixelHeight: 832,
                            pixelWidth: 994,
                            sizes: "-172.0905px",
                            src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                        ...
                        className: "framer-1cuukxv hidden-1tai7yd hidden-180ph05 hidden-xp04m8",
                        "data-framer-name": "Block",
                        "data-nosnippet": true,
                        drag: true,
                        dragMomentum: false,
                        ...
                        children: [ /*#__PURE__*/ _jsxs("div", {
                            ...
                            children: [ /*#__PURE__*/ _jsxs("div", {
                                ...
                                children: [ /*#__PURE__*/ _jsxs("div", {
                                            ...
                                            Q1XUigOVv: {
                                                children: /*#__PURE__*/ _jsx(React.Fragment, {
                                                    children: /*#__PURE__*/ _jsx("p", {
                                                        ...
                                                        children: "Explore frequently asked questions."
                                                    })
                                                }),
                                                fonts: ["GF;Plus Jakarta Sans-regular"]
                                            }
                                        ...
                                        children: /*#__PURE__*/ _jsx(RichText, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(React.Fragment, {
                                                children: /*#__PURE__*/ _jsx("p", {
                                                    ...
                                                    children: "Haven’t found what you’re looking for? Contact us"
                                                })
                                            }),
                                    ...
                                    children: /*#__PURE__*/ _jsx(PropertyOverrides, {
                                        ...
                                        overrides: {
                                            jeCnrh3kk: {
                                                y: (componentViewport ? .y || 0) + 0 + 2910.5 + 0 + 0 + 0 + 88 + 0 + 0 + 0 + 0
                                            },
                                            Q1XUigOVv: {
                                                width: `min(min(${componentViewport?.width||"100vw"}, 1280px) - 32px, 1200px)`,
                                                y: undefined
                                            },
                                            XWGQJU3bM: {
                                                width: `min((min(${componentViewport?.width||"100vw"}, 1280px) - 64px) * 0.9, 768px)`,
                                                y: (componentViewport ? .y || 0) + 0 + 3248.5 + 0 + 0 + 0 + 80 + 0 + 0 + 226 + 0 + 0
                                            }
                                        },
                                        children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                            height: 392,
                                            width: `calc(min(min(${componentViewport?.width||"100vw"}, 1280px) - 64px, 1200px) * 0.5917)`,
                                            y: (componentViewport ? .y || 0) + 0 + 2989.5 + 0 + 0 + 0 + 80 + 0 + 0 + 0 + 0,
                                            children: /*#__PURE__*/ _jsx(Container, {
                                                ...
                                                ref: ref2,
                                                scopeId: "augiA20Il",
                                                children: /*#__PURE__*/ _jsx(FaqArea, {
                                                    height: "100%",
                                                    id: "bj_yV4awM",
                                                    layoutId: "bj_yV4awM",
                                                    name: "Faq Area",
                                    ...
                                    children: /*#__PURE__*/ _jsxs("div", {
                                        ...
                                        children: [ /*#__PURE__*/ _jsx(PropertyOverrides, {
                                            ...
                                            children: /*#__PURE__*/ _jsx(RichText, {
                                                ...
                                                "data-framer-name": "What do you want to see in your new IdP?",
                                                fonts: ["GF;Plus Jakarta Sans-500"],
                            ...
                            overrides: {
                                jeCnrh3kk: {
                                    background: {
                                        ...
                                        intrinsicHeight: 388.8,
                                        intrinsicWidth: 464,
                                        loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 2910.5 + 0 + 974.8 - 510),
                                        pixelHeight: 832,
                                        pixelWidth: 994,
                                        sizes: "191px",
                                        src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                            ...
                            children: /*#__PURE__*/ _jsx(ImageWithFX, {
                                ...
                                background: {
                                    ...
                                    intrinsicHeight: 388.8,
                                    intrinsicWidth: 464,
                                    loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 2989.5 + 0 + 0),
                                    pixelHeight: 832,
                                    pixelWidth: 994,
                                    sizes: "191px",
                                    src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                                ...
                                className: "framer-1phovde hidden-180ph05 hidden-xp04m8",
                                "data-framer-name": "Block",
                                drag: true,
                                dragMomentum: false,
                                dragSnapToOrigin: true,
                        ...
                        }), isDisplayed6() && /*#__PURE__*/ _jsx(ImageWithFX, {
                            __framer__loop: animation4,
                            __framer__loopEffectEnabled: true,
                            __framer__loopRepeatDelay: 0,
                            __framer__loopRepeatType: "mirror",
                            ...
                            background: {
                                ...
                                intrinsicHeight: 388.8,
                                intrinsicWidth: 464,
                                loading: getLoadingLazyAtYPosition((componentViewport ? .y || 0) + 0 + 2989.5 + 0 + 514.0019),
                                pixelHeight: 832,
                                pixelWidth: 994,
                                sizes: "191px",
                                src: "https://framerusercontent.com/images/KXywEnyh0ECWhT6VdpadeB4No9c.png?scale-down-to=512&width=994&height=832",
                            ...
                            className: "framer-19sohj4 hidden-1tai7yd hidden-180ph05 hidden-xp04m8",
                            "data-framer-name": "Block",
                            drag: true,
                            dragMomentum: false,
                            dragSnapToOrigin: true,
                    ...
                    children: /*#__PURE__*/ _jsx(MotionDivWithFX, {
                        ...
                        children: /*#__PURE__*/ _jsx(PropertyOverrides, {
                            ...
                            overrides: {
                                jeCnrh3kk: {
                                    y: (componentViewport ? .y || 0) + -34.2618 + 0
                                },
                                Q1XUigOVv: {
                                    height: 637,
                                    width: `calc(${componentViewport?.width||"100vw"} * 2.6563)`,
                                    y: undefined
                                },
                                XWGQJU3bM: {
                                    y: (componentViewport ? .y || 0) + -1824.179 + 0
                                }
                            },
                            children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                                height: 720,
                                width: componentViewport ? .width || "100vw",
                                y: (componentViewport ? .y || 0) + -34.7676 + 0,
                                children: /*#__PURE__*/ _jsx(ContainerWithFX, {
                                    __framer__animate: {
                                        transition: transition17
                                    },
                    ...
                    overrides: {
                        jeCnrh3kk: {
                            y: (componentViewport ? .y || 0) + 0 + 3885.3
                        },
                        Q1XUigOVv: {
                            width: componentViewport ? .width || "100vw",
                            y: undefined
                        ...
                        XWGQJU3bM: {
                            width: componentViewport ? .width || "100vw",
                            y: (componentViewport ? .y || 0) + 0 + 4329.3
                        }
                    },
                    children: /*#__PURE__*/ _jsx(ComponentViewportProvider, {
                        height: 111,
                        width: "1248px",
                        y: (componentViewport ? .y || 0) + 0 + 3944.3,
                        children: /*#__PURE__*/ _jsx(Container, {
...
const css = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-7mOOl.framer-lux5qc, .framer-7mOOl .framer-lux5qc { display: block; }", ".framer-7mOOl.framer-72rtr7 { align-content: center; align-items: center; background-color: var(--token-7d27c033-cb66-44c8-bf4e-e66d9f19511b, #ffffff); display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 1519px; }", ".framer-7mOOl .framer-117ms87-container { flex: none; height: auto; left: 50%; max-width: 1280px; position: fixed; top: 0px; transform: translateX(-50%); width: 100%; z-index: 10; }", ".framer-7mOOl .framer-hw1qfl { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; z-index: 1; }", ".framer-7mOOl .framer-av2csc-container { flex: none; height: auto; max-width: 1280px; position: relative; width: 83%; z-index: 10; }", ".framer-7mOOl .framer-1n81jq3 { flex: none; gap: 0px; height: 949px; left: calc(50.00000000000002% - 1216px / 2); overflow: visible; position: absolute; top: -662px; width: 1216px; z-index: 0; }", ".framer-7mOOl .framer-1v5s4c7 { flex: none; height: 968px; left: -64px; opacity: 0.4; overflow: visible; position: absolute; right: -74px; top: -120px; }", ".framer-7mOOl .framer-bkigbe { -webkit-filter: blur(169.4630889892578px); background-color: var(--token-683467f2-96b0-424a-962f-8ef95192a805, rgba(68, 113, 227, 0)); border-bottom-left-radius: 100%; border-bottom-right-radius: 100%; border-top-left-radius: 100%; border-top-right-radius: 100%; filter: blur(169.4630889892578px); flex: none; height: 922px; left: calc(49.99999549223409% - 922px / 2); position: absolute; top: 0px; width: 922px; }", ".framer-7mOOl .framer-dld4a3 { -webkit-filter: blur(169.4630889892578px); background-color: var(--token-e6d6bcc5-5555-47a5-9b22-c5cc2c9fe40b, rgba(255, 217, 120, 0)); border-bottom-left-radius: 100%; border-bottom-right-radius: 100%; border-top-left-radius: 100%; border-top-right-radius: 100%; bottom: 0px; filter: blur(169.4630889892578px); flex: none; height: 725px; left: calc(49.99999549223409% - 725px / 2); opacity: 0.6; position: absolute; width: 725px; }", ".framer-7mOOl .framer-171to5k { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1280px; overflow: visible; padding: 8px 32px 8px 32px; position: relative; width: 100%; }", ".framer-7mOOl .framer-19lzdxx { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; max-width: 1280px; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-7mOOl .framer-3qczc4 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 1px; z-index: 1; }", ".framer-7mOOl .framer-kz8x7m, .framer-7mOOl .framer-vzji2j { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 24px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1257qf2-container, .framer-7mOOl .framer-1j1qadg-container, .framer-7mOOl .framer-1y324kx-container, .framer-7mOOl .framer-1bclzx5-container, .framer-7mOOl .framer-4m2yj1-container, .framer-7mOOl .framer-yfl9o5-container { flex: none; height: auto; position: relative; width: auto; }", ".framer-7mOOl .framer-1j1lpgd, .framer-7mOOl .framer-jwq1a0, .framer-7mOOl .framer-d50tri { flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-pvzydo { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 183px; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1ncsbu9 { flex: none; height: auto; max-width: 580px; position: relative; white-space: pre-wrap; width: 580px; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-1ock6vn { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 20px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-v5ef1j { flex: none; gap: 0px; height: 588px; overflow: visible; position: relative; width: 581px; z-index: 0; }", ".framer-7mOOl .framer-i7bazi { flex: none; gap: 0px; height: 366px; overflow: visible; position: absolute; right: -379px; top: calc(50.00000000000002% - 366px / 2); width: 935px; }", ".framer-7mOOl .framer-15o9xad { flex: none; height: 397px; position: absolute; right: -57px; top: calc(48.90710382513663% - 397px / 2); width: 772px; }", ".framer-7mOOl .framer-1fug4zx { background-color: rgba(0, 0, 0, 0); flex: none; height: 349px; left: -594px; opacity: 0.38; position: absolute; top: calc(49.18032786885248% - 349px / 2); width: 601px; }", ".framer-7mOOl .framer-16le7zk { --border-bottom-width: 1px; --border-color: var(--token-f95fb56e-4771-4c58-8209-85424335f200, rgba(255, 255, 255, 0.14)); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; -webkit-backdrop-filter: blur(3px); align-content: center; align-items: center; backdrop-filter: blur(3px); background-color: var(--token-04385c6a-b457-45ee-a038-29ff13480ba8, rgba(255, 255, 255, 0.09)); border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 220px; justify-content: center; left: 0px; overflow: hidden; padding: 0px; position: absolute; top: calc(47.81096260416337% - 220px / 2); width: 220px; will-change: var(--framer-will-change-override, transform); }", ".framer-7mOOl .framer-1ujfmr4 { -webkit-filter: blur(18.5px); background-color: var(--token-7049cce7-715e-45a0-a41e-932274474306, #09e308); border-bottom-left-radius: 39px; border-bottom-right-radius: 39px; border-top-left-radius: 39px; border-top-right-radius: 39px; filter: blur(18.5px); flex: none; height: 59px; position: absolute; right: -12px; top: calc(51.81818181818184% - 59px / 2); width: 26px; z-index: 1; }", ".framer-7mOOl .framer-cm59nh { -webkit-filter: blur(18.5px); background-color: var(--token-bf824105-d7d5-474a-9629-86627c46ddec, #000000); border-bottom-left-radius: 39px; border-bottom-right-radius: 39px; border-top-left-radius: 39px; border-top-right-radius: 39px; filter: blur(18.5px); flex: none; height: 60px; left: -12px; opacity: 0.38; position: absolute; top: calc(51.36363636363639% - 60px / 2); width: 26px; z-index: 1; }", ".framer-7mOOl .framer-1oxlnpr { flex: none; height: 77px; position: relative; width: 82px; }", ".framer-7mOOl .framer-13iqdum-container { flex: none; height: 100%; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: calc(50.00000000000002% - 100% / 2); width: 100%; z-index: 1; }", ".framer-7mOOl .framer-1rndu0q { aspect-ratio: 1.1934156378600822 / 1; bottom: 342px; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 91px); left: 360px; overflow: visible; position: absolute; width: 108px; z-index: 1; }", ".framer-7mOOl .framer-j125pk { aspect-ratio: 1.1934156378600822 / 1; bottom: 30px; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 117px); left: 268px; overflow: visible; position: absolute; width: 140px; z-index: 1; }", ".framer-7mOOl .framer-1xqsn5e { aspect-ratio: 1 / 1; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 186px); left: 215px; overflow: visible; position: absolute; top: -70px; width: 186px; z-index: 1; }", ".framer-7mOOl .framer-1vr5n4q { aspect-ratio: 1 / 1; bottom: -4px; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 188px); left: 471px; overflow: visible; position: absolute; width: 188px; z-index: 1; }", ".framer-7mOOl .framer-1bwcu5b { -webkit-filter: brightness(0.92); aspect-ratio: 1 / 1; cursor: grab; filter: brightness(0.92); flex: none; height: var(--framer-aspect-ratio-supported, 126px); left: 47%; overflow: visible; position: absolute; top: 21px; transform: translateX(-50%); width: 126px; z-index: 1; }", ".framer-7mOOl .framer-1c3liat { aspect-ratio: 1 / 1; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 140px); left: 493px; overflow: visible; position: absolute; top: -40px; width: 140px; z-index: 1; }", ".framer-7mOOl .framer-1rnky7f { aspect-ratio: 1 / 1; bottom: 91px; cursor: grab; flex: none; height: var(--framer-aspect-ratio-supported, 133px); left: 49%; overflow: visible; position: absolute; transform: translateX(-50%); width: 133px; z-index: 1; }", ".framer-7mOOl .framer-yoi48h { -webkit-filter: brightness(0.92); aspect-ratio: 1 / 1; bottom: 53px; cursor: grab; filter: brightness(0.92); flex: none; height: var(--framer-aspect-ratio-supported, 126px); left: 412px; overflow: visible; position: absolute; width: 126px; z-index: 1; }", ".framer-7mOOl .framer-15hed9b { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 25px 0px 0px 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-17twc6k-container { flex: none; height: 118px; max-width: 100%; position: relative; width: 87%; will-change: var(--framer-will-change-effect-override, transform); z-index: 2; }", ".framer-7mOOl .framer-rlkxvq { background-color: rgba(196, 16, 16, 0); height: 79px; position: relative; width: 221px; }", ".framer-7mOOl .framer-1xg5v3q { height: 67px; position: relative; width: 166px; }", ".framer-7mOOl .framer-1fi0lp3 { height: 61px; position: relative; width: 84px; }", ".framer-7mOOl .framer-1dlzcvs { height: 61px; position: relative; width: 207px; }", ".framer-7mOOl .framer-ib2qfr { height: 61px; position: relative; width: 391px; }", ".framer-7mOOl .framer-128m11y { --border-bottom-width: 1px; --border-color: var(--token-eeeebe0f-b246-4d8c-a158-74908ab2e2e3, #d9d9d9); --border-left-width: 0px; --border-right-width: 0px; --border-style: dashed; --border-top-width: 1px; align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 138px; height: min-content; justify-content: center; overflow: visible; padding: 52px 0px 52px 0px; position: relative; width: min-content; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl .framer-8e1bmi, .framer-7mOOl .framer-m9k93s, .framer-7mOOl .framer-g9zb2a, .framer-7mOOl .framer-13rryyb { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 6px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-7mOOl .framer-1na77cf, .framer-7mOOl .framer-1ghxpl6, .framer-7mOOl .framer-1e679xj, .framer-7mOOl .framer-19d5gbk { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; }", ".framer-7mOOl .framer-ayti8r, .framer-7mOOl .framer-sfjvbl, .framer-7mOOl .framer-wapf38, .framer-7mOOl .framer-1vmj7ye, .framer-7mOOl .framer-dv03z3, .framer-7mOOl .framer-1yxc21a, .framer-7mOOl .framer-imx0dn, .framer-7mOOl .framer-1dnqelm { --framer-paragraph-spacing: 0px; flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-7mOOl .framer-1212kh8 { flex: none; height: 449px; overflow: visible; position: relative; width: 1520px; }", ".framer-7mOOl .framer-136vdzm { -webkit-user-select: none; flex: none; height: auto; left: 50%; pointer-events: auto; position: absolute; top: 96px; transform: translateX(-50%); user-select: none; white-space: pre; width: auto; }", ".framer-7mOOl .framer-ozew3n { -webkit-user-select: none; flex: none; height: auto; left: 50%; pointer-events: auto; position: absolute; top: 187px; transform: translateX(-50%); user-select: none; white-space: pre; width: auto; }", ".framer-7mOOl .framer-1akw1mh { -webkit-user-select: none; flex: none; height: auto; left: 50%; pointer-events: auto; position: absolute; top: 128px; transform: translateX(-50%); user-select: none; white-space: pre; width: auto; }", ".framer-7mOOl .framer-p2hyij { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 30px; height: 82px; justify-content: center; left: 50%; overflow: hidden; padding: 0px; position: absolute; top: 265px; transform: translateX(-50%); width: min-content; }", ".framer-7mOOl .framer-1ganoji, .framer-7mOOl .framer-nfpc8u, .framer-7mOOl .framer-1wa5cgn, .framer-7mOOl .framer-s2d6gu, .framer-7mOOl .framer-12f53rz, .framer-7mOOl .framer-1izs7jp, .framer-7mOOl .framer-1iup5ag { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 80px); position: relative; width: 80px; }", ".framer-7mOOl .framer-7wfos3, .framer-7mOOl .framer-12anijm { aspect-ratio: 0.9984639016897082 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 73px); overflow: visible; position: relative; width: 72px; }", ".framer-7mOOl .framer-14q7ajt { display: grid; flex: none; gap: 9px; grid-auto-rows: min-content; grid-template-columns: repeat(9, minmax(50px, 1fr)); grid-template-rows: repeat(2, min-content); height: min-content; justify-content: center; left: 50%; overflow: hidden; padding: 0px; position: absolute; top: 251px; transform: translateX(-50%); width: min-content; }", ".framer-7mOOl .framer-1qj26li, .framer-7mOOl .framer-1tsrdml, .framer-7mOOl .framer-roczm4, .framer-7mOOl .framer-1apo83n, .framer-7mOOl .framer-1py3vzg, .framer-7mOOl .framer-15fnzvr, .framer-7mOOl .framer-10w9r2f, .framer-7mOOl .framer-13t7dvm, .framer-7mOOl .framer-1q2b1s6 { align-self: start; aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 80px); justify-self: start; position: relative; width: 100%; }", ".framer-7mOOl .framer-1quyz1w, .framer-7mOOl .framer-ps4c9d { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 52px; height: min-content; justify-content: center; max-width: 1280px; overflow: visible; padding: 0px 32px 40px 32px; position: relative; width: 83%; }", ".framer-7mOOl .framer-17sbmwn { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 5px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-evb4ej, .framer-7mOOl .framer-1q7idue { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-o9dqnn, .framer-7mOOl .framer-1zuw21 { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; --framer-paragraph-spacing: 0px; flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-7mOOl .framer-3u8mf7, .framer-7mOOl .framer-1a8nohw { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; --framer-paragraph-spacing: 0px; flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-1t2etvs { aspect-ratio: 1.1934156378600822 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 224px); left: -169px; overflow: visible; position: absolute; top: 51px; width: 267px; z-index: 1; }", ".framer-7mOOl .framer-vn9x9r { aspect-ratio: 1.1934156378600822 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 97px); left: 101px; overflow: visible; position: absolute; top: 26px; width: 115px; z-index: 1; }", ".framer-7mOOl .framer-k7ney { display: grid; flex: none; gap: 14px; grid-auto-rows: minmax(0, 1fr); grid-template-columns: repeat(5, minmax(50px, 1fr)); grid-template-rows: repeat(2, minmax(0, 1fr)); height: min-content; justify-content: center; max-width: 1200px; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-85eg8i, .framer-7mOOl .framer-hanm0d, .framer-7mOOl .framer-1az6435, .framer-7mOOl .framer-1kndl8r, .framer-7mOOl .framer-1ao794p, .framer-7mOOl .framer-yksecg, .framer-7mOOl .framer-j97575, .framer-7mOOl .framer-1cbmlvx, .framer-7mOOl .framer-18nxhsg { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; background-color: var(--token-089902dc-7814-4806-9ea4-082cfc96df83, #f0f0f0); border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 28px; height: 100%; justify-content: center; justify-self: start; overflow: hidden; padding: 40px 47px 40px 47px; position: relative; width: min-content; will-change: var(--framer-will-change-override, transform); }", ".framer-7mOOl .framer-1cgjt3l, .framer-7mOOl .framer-103iyjy, .framer-7mOOl .framer-1wrd7lh, .framer-7mOOl .framer-17ja6ah, .framer-7mOOl .framer-dsy09z, .framer-7mOOl .framer-no6vp4, .framer-7mOOl .framer-15vfdwb, .framer-7mOOl .framer-qronkf, .framer-7mOOl .framer-14m5wfj, .framer-7mOOl .framer-zt38q9, .framer-7mOOl .framer-mefgcn, .framer-7mOOl .framer-13n63cz, .framer-7mOOl .framer-18wsno1, .framer-7mOOl .framer-3z2pae, .framer-7mOOl .framer-1rcm3a7, .framer-7mOOl .framer-1t5ujc8, .framer-7mOOl .framer-14kr3zv, .framer-7mOOl .framer-1mn93zs, .framer-7mOOl .framer-3gi99x, .framer-7mOOl .framer-3ufw93 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; }", ".framer-7mOOl .framer-ofz8mk, .framer-7mOOl .framer-1j6jvka, .framer-7mOOl .framer-fxt8lq, .framer-7mOOl .framer-1g115jf, .framer-7mOOl .framer-8ev09z, .framer-7mOOl .framer-ippcvq, .framer-7mOOl .framer-1cqrde5, .framer-7mOOl .framer-1cf802q, .framer-7mOOl .framer-801utb, .framer-7mOOl .framer-487djs { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 100px); overflow: visible; position: relative; width: 100px; }", ".framer-7mOOl .framer-1p2mdfk, .framer-7mOOl .framer-10mqin3, .framer-7mOOl .framer-19e7f19, .framer-7mOOl .framer-etxgq9, .framer-7mOOl .framer-hr81mf, .framer-7mOOl .framer-1fo6chx, .framer-7mOOl .framer-ji4ooq, .framer-7mOOl .framer-z64c7b, .framer-7mOOl .framer-1ys60h9, .framer-7mOOl .framer-rtwtso { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; --framer-paragraph-spacing: 0px; flex: none; height: auto; position: relative; white-space: pre-wrap; width: 132px; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-bzz9hc { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; background-color: var(--token-089902dc-7814-4806-9ea4-082cfc96df83, #f0f0f0); border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 12px; height: 100%; justify-content: center; justify-self: start; overflow: hidden; padding: 40px 47px 40px 47px; position: relative; width: min-content; will-change: var(--framer-will-change-override, transform); }", ".framer-7mOOl .framer-1i2xjtq { aspect-ratio: 1.1934156378600822 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 210px); overflow: visible; position: absolute; right: -168px; top: -38px; width: 251px; z-index: 1; }", ".framer-7mOOl .framer-1hmt24w { aspect-ratio: 1.1934156378600822 / 1; bottom: 28px; flex: none; height: var(--framer-aspect-ratio-supported, 127px); left: -96px; overflow: visible; position: absolute; width: 151px; z-index: 1; }", ".framer-7mOOl .framer-1yyjn0n { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 11px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1goigrv { -webkit-user-select: none; flex: none; height: auto; pointer-events: auto; position: relative; user-select: none; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-1pybend { -webkit-user-select: none; flex: none; height: auto; pointer-events: auto; position: relative; user-select: none; white-space: pre; width: auto; }", ".framer-7mOOl .framer-17ve921 { display: grid; flex: none; gap: 63px; grid-auto-rows: minmax(0, 1fr); grid-template-columns: repeat(4, minmax(50px, 1fr)); grid-template-rows: repeat(2, minmax(0, 1fr)); height: min-content; justify-content: center; max-width: 1200.04px; overflow: visible; padding: 31px 0px 31px 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1ywqqkv, .framer-7mOOl .framer-oyyjfm, .framer-7mOOl .framer-hm2k0l, .framer-7mOOl .framer-1gfq8rt { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: column; flex-wrap: wrap; gap: 12px; height: min-content; justify-content: center; justify-self: start; overflow: visible; padding: 0px; position: relative; width: 100%; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl .framer-pnykgl-container { flex: none; height: 516px; min-width: 300px; position: relative; width: 306px; }", ".framer-7mOOl .framer-1bnxnjp-container { flex: none; height: 519px; min-width: 300px; position: relative; width: 300px; }", ".framer-7mOOl .framer-ifo4ea-container { flex: none; height: 511px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-3594cg { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: column; flex-wrap: wrap; gap: 20px 12px; height: min-content; justify-content: center; justify-self: start; overflow: visible; padding: 0px; position: relative; width: 100%; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl .framer-1m31npg-container, .framer-7mOOl .framer-v5y587-container { flex: none; height: 505px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-8nj5qx { display: grid; flex: none; gap: 32px; grid-auto-rows: minmax(0, 1fr); grid-template-columns: repeat(3, minmax(50px, 1fr)); grid-template-rows: repeat(2, minmax(0, 1fr)); height: min-content; justify-content: center; max-width: 1200px; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1erp167, .framer-7mOOl .framer-1449j0v, .framer-7mOOl .framer-murt2q, .framer-7mOOl .framer-1an9h9, .framer-7mOOl .framer-158s6tn, .framer-7mOOl .framer-ynnrj, .framer-7mOOl .framer-rti5h1, .framer-7mOOl .framer-1xil1if, .framer-7mOOl .framer-1o6f7yl { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; cursor: pointer; display: flex; flex: none; flex-direction: column; flex-wrap: wrap; gap: 12px; height: min-content; justify-content: center; justify-self: start; overflow: visible; padding: 0px; position: relative; width: 100%; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl.framer-1h100fc, .framer-7mOOl.framer-b3pmqq, .framer-7mOOl.framer-1yqudl9, .framer-7mOOl.framer-ju1chp, .framer-7mOOl.framer-1j1s821, .framer-7mOOl.framer-g7qm0x, .framer-7mOOl.framer-k05ova, .framer-7mOOl.framer-ga09d8, .framer-7mOOl.framer-1ecdkeg, .framer-7mOOl.framer-1nrruj9, .framer-7mOOl.framer-1vh7a2y, .framer-7mOOl.framer-1i1absw, .framer-7mOOl.framer-1asgtwm, .framer-7mOOl.framer-39oadp, .framer-7mOOl.framer-nr8cxd { background-color: rgba(33, 33, 33, 0.6); inset: 0px; position: fixed; user-select: none; z-index: 10; }", ".framer-7mOOl.framer-9auitt, .framer-7mOOl.framer-d70vma, .framer-7mOOl.framer-15zctwb { align-content: flex-start; align-items: flex-start; background-color: #050505; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 532px; justify-content: flex-start; left: calc(49.30875576036868% - 788px / 2); overflow: hidden; padding: 20px; position: fixed; top: calc(48.868778280543005% - 532px / 2); width: 788px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-1ikjks3, .framer-7mOOl .framer-og8grk, .framer-7mOOl .framer-rovif2, .framer-7mOOl .framer-642ihm, .framer-7mOOl .framer-d3sbu2, .framer-7mOOl .framer-1hpmjv7, .framer-7mOOl .framer-sp1i4e, .framer-7mOOl .framer-12lha19, .framer-7mOOl .framer-lz6jab, .framer-7mOOl .framer-p58b54, .framer-7mOOl .framer-1g4kg2s, .framer-7mOOl .framer-1vkuvue, .framer-7mOOl .framer-thb99j, .framer-7mOOl .framer-am1lwv, .framer-7mOOl .framer-1ulm9iq { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; height: min-content; justify-content: space-between; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-44hs4q, .framer-7mOOl .framer-2eri9h, .framer-7mOOl .framer-1y7t8bf, .framer-7mOOl .framer-7dlo5z, .framer-7mOOl .framer-dfs4oe, .framer-7mOOl .framer-cjhwy4, .framer-7mOOl .framer-lwssnz, .framer-7mOOl .framer-1525xdu, .framer-7mOOl .framer-14u23qw, .framer-7mOOl .framer-vb675d, .framer-7mOOl .framer-v30s9e, .framer-7mOOl .framer-qfsrpu, .framer-7mOOl .framer-d4hz9o, .framer-7mOOl .framer-1t3x7pn, .framer-7mOOl .framer-xshd1e { cursor: pointer; flex: none; height: 20px; overflow: visible; position: relative; width: 20px; }", ".framer-7mOOl .framer-d6jl8d, .framer-7mOOl .framer-4bjp2o, .framer-7mOOl .framer-1edlytx, .framer-7mOOl .framer-1um3tcc, .framer-7mOOl .framer-1q7ldri, .framer-7mOOl .framer-qtyv4h, .framer-7mOOl .framer-1cgldwt, .framer-7mOOl .framer-1ej7byw, .framer-7mOOl .framer-agmmrf, .framer-7mOOl .framer-1fhaics, .framer-7mOOl .framer-14y3civ, .framer-7mOOl .framer-gqjh90, .framer-7mOOl .framer-17m0c6q, .framer-7mOOl .framer-s9w34c, .framer-7mOOl .framer-1bw8t5a { flex: none; height: 20px; left: calc(50.00000000000002% - 20px / 2); position: absolute; top: calc(50.00000000000002% - 20px / 2); width: 20px; }", ".framer-7mOOl .framer-1s3nvo, .framer-7mOOl .framer-18q70nj, .framer-7mOOl .framer-byj2dy, .framer-7mOOl .framer-1ybsfuz, .framer-7mOOl .framer-1idxyfk, .framer-7mOOl .framer-6pb3kq, .framer-7mOOl .framer-1agcd6m, .framer-7mOOl .framer-5vvf03, .framer-7mOOl .framer-1tsbi4w, .framer-7mOOl .framer-13yncjs, .framer-7mOOl .framer-1o8ugw9, .framer-7mOOl .framer-am45lx, .framer-7mOOl .framer-14euav8, .framer-7mOOl .framer-1wtspxr, .framer-7mOOl .framer-rrq234 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 2px; height: min-content; justify-content: flex-start; min-height: 17px; min-width: 66px; overflow: visible; padding: 0px; position: relative; width: min-content; }", ".framer-7mOOl .framer-1gcq60n, .framer-7mOOl .framer-1muluri, .framer-7mOOl .framer-1wa3ffs, .framer-7mOOl .framer-1upm32p, .framer-7mOOl .framer-fhonee, .framer-7mOOl .framer-oej0dq, .framer-7mOOl .framer-12itxsf, .framer-7mOOl .framer-1c1nlt5, .framer-7mOOl .framer-13gen3i, .framer-7mOOl .framer-1hsd482, .framer-7mOOl .framer-wchvvx, .framer-7mOOl .framer-1y8u38w, .framer-7mOOl .framer-60m3ng, .framer-7mOOl .framer-1axwptv, .framer-7mOOl .framer-1dcb64d { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 4px; height: 1px; justify-content: flex-end; overflow: visible; padding: 20px 0px 0px 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-8ofj6q, .framer-7mOOl .framer-1sy3vvo, .framer-7mOOl .framer-w4hx1g, .framer-7mOOl .framer-1ouv0hh, .framer-7mOOl .framer-1vmmqrj, .framer-7mOOl .framer-n2f5wi, .framer-7mOOl .framer-1a32hb8, .framer-7mOOl .framer-6d88di, .framer-7mOOl .framer-13uoqwb, .framer-7mOOl .framer-1wkvz5c, .framer-7mOOl .framer-13hdv2l, .framer-7mOOl .framer-1vlx4ev, .framer-7mOOl .framer-u4dowx, .framer-7mOOl .framer-1qzusy8 { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; flex: none; height: auto; max-width: 1034px; position: relative; white-space: pre-wrap; width: auto; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-uo6tz2-container { flex: none; height: 526px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-i3vdr1 { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; align-self: start; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; cursor: pointer; display: flex; flex: none; flex-direction: column; flex-wrap: wrap; gap: 12px; height: 518px; justify-content: center; justify-self: start; overflow: visible; padding: 0px; position: relative; width: 100%; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl.framer-1if1c0n, .framer-7mOOl.framer-4md5t3, .framer-7mOOl.framer-15elhha { align-content: flex-start; align-items: flex-start; background-color: #050505; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 642px; justify-content: flex-start; left: calc(51.81040157998685% - 1032px / 2); overflow: hidden; padding: 20px; position: fixed; top: calc(50.2513826043238% - 642px / 2); width: 1032px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-l5qj57-container { flex: none; height: 100%; min-width: 300px; position: relative; width: 96%; }", ".framer-7mOOl.framer-awxle2, .framer-7mOOl.framer-17wyyei, .framer-7mOOl.framer-1i48b93, .framer-7mOOl.framer-12nad2b, .framer-7mOOl.framer-9u7okj, .framer-7mOOl.framer-hdhl4y { align-content: flex-start; align-items: flex-start; background-color: #050505; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 750px; justify-content: flex-start; left: calc(52.99539170506915% - 1000px / 2); overflow: hidden; padding: 20px; position: fixed; top: calc(51.60884866767223% - 750px / 2); width: 1000px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-vidpj7-container { flex: none; height: 463px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-11qrvws-container { flex: none; height: 518px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl.framer-1kmk614 { align-content: flex-start; align-items: flex-start; background-color: var(--token-089902dc-7814-4806-9ea4-082cfc96df83, #f0f0f0); border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 486px; justify-content: flex-start; left: calc(52.96875000000002% - 1000px / 2); overflow: hidden; padding: 20px; position: fixed; top: calc(54.92709904474613% - 486px / 2); width: 1000px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-he8xwy-container { flex: none; height: 462px; min-width: 300px; position: relative; width: 312px; }", ".framer-7mOOl .framer-17jovs7 { display: grid; flex: none; gap: 32px; grid-auto-rows: minmax(0, 1fr); grid-template-columns: repeat(2, minmax(50px, 1fr)); grid-template-rows: repeat(3, minmax(0, 1fr)); height: min-content; justify-content: center; max-width: 1200px; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-evi2uq-container { flex: none; height: 517px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-y00tt9-container { flex: none; height: 515px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-monuun-container, .framer-7mOOl .framer-hheqml-container { flex: none; height: 479px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1a2tpk0-container { flex: none; height: 567px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl.framer-1cg1hj4 { align-content: flex-start; align-items: flex-start; background-color: var(--token-089902dc-7814-4806-9ea4-082cfc96df83, #f0f0f0); border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 466px; justify-content: flex-start; left: calc(50.00000000000002% - 768px / 2); overflow: hidden; padding: 20px; position: fixed; top: calc(66.57407407407409% - 466px / 2); width: 768px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-15ctgro { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; flex: none; height: auto; max-width: 1034px; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }", ".framer-7mOOl .framer-1tzbzly { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: center; max-width: 1200px; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-mqt67n, .framer-7mOOl .framer-32qjfq, .framer-7mOOl .framer-qln1dk, .framer-7mOOl .framer-14xtu1x { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; cursor: pointer; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: wrap; gap: 12px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl .framer-1188ypm-container { flex: none; height: 519px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1gaq0n5-container { flex: none; height: 516px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1txnp0l-container { flex: none; height: 420px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1ljrcta-container { flex: none; height: 439px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-jpvyd2 { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; cursor: pointer; display: flex; flex: none; flex-direction: column; flex-wrap: wrap; gap: 7px; height: min-content; justify-content: center; overflow: visible; padding: 20px; position: relative; width: 100%; will-change: var(--framer-will-change-effect-override, transform); }", ".framer-7mOOl.framer-1g5rblz { align-content: flex-start; align-items: flex-start; background-color: var(--token-089902dc-7814-4806-9ea4-082cfc96df83, #f0f0f0); border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px; box-shadow: 0px 30px 60px 0px rgba(0, 0, 0, 0.1), inset 0px 0px 2px 0px rgba(255, 255, 255, 0.25); display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: 842px; justify-content: flex-start; left: calc(50.00000000000002% - 272px / 2); overflow: hidden; padding: 20px; position: fixed; top: 260px; width: 272px; will-change: var(--framer-will-change-effect-override, transform); z-index: 10; }", ".framer-7mOOl .framer-tp6a9j-container { flex: none; height: 394px; min-width: 300px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1fkiv3s { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1cuukxv { aspect-ratio: 1.1934156378600822 / 1; bottom: 20px; flex: none; left: 1%; overflow: visible; position: absolute; top: 1079px; transform: translateX(-50%); width: var(--framer-aspect-ratio-supported, 0px); z-index: 1; }", ".framer-7mOOl .framer-yhu483 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 82px; height: min-content; justify-content: center; max-width: 1280px; overflow: visible; padding: 80px 32px 40px 32px; position: relative; width: 100%; }", ".framer-7mOOl .framer-1qkab9s { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; max-width: 1200px; overflow: visible; padding: 0px 0px 10px 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-apeq29 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: center; overflow: hidden; padding: 0px 40px 0px 0px; position: relative; width: 41%; }", ".framer-7mOOl .framer-4jl14v { align-content: flex-end; align-items: flex-end; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 16px; height: min-content; justify-content: flex-end; overflow: hidden; padding: 0px; position: relative; width: 59%; }", ".framer-7mOOl .framer-1z0rjbm-container { flex: none; height: auto; position: relative; scroll-margin-top: 200px; width: 100%; }", ".framer-7mOOl .framer-1aboqt0 { --border-bottom-width: 1px; --border-color: rgba(255, 255, 255, 0.05); --border-left-width: 1px; --border-right-width: 1px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; background-color: var(--token-73e1ab91-3c39-4d8d-95db-c8dede17e4ca, rgba(48, 48, 48, 0.1)); border-bottom-left-radius: 20px; border-bottom-right-radius: 20px; border-top-left-radius: 20px; border-top-right-radius: 20px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 70px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 40px 30px 40px 30px; position: relative; width: 100%; will-change: var(--framer-will-change-override, transform); }", ".framer-7mOOl .framer-i8rgto { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 32px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 1px; }", ".framer-7mOOl .framer-m0m4x2 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 34px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-vjpm0g { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }", ".framer-7mOOl .framer-q10wg7 { background-color: rgba(0, 0, 0, 0); flex: none; height: 66px; position: relative; width: 317px; }", ".framer-7mOOl .framer-1p1d0l6 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 110px; justify-content: center; overflow: hidden; padding: 0px 17px 0px 52px; position: relative; width: min-content; }", ".framer-7mOOl .framer-1mblgp0 { background-color: rgba(196, 16, 16, 0); flex: none; height: 105px; position: relative; width: 293px; }", ".framer-7mOOl .framer-1an7n43 { flex: none; height: 196px; position: relative; width: 349px; }", ".framer-7mOOl .framer-1phovde { aspect-ratio: 1.1934156378600822 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 160px); left: -60px; overflow: visible; position: absolute; top: 0px; width: 191px; z-index: 1; }", ".framer-7mOOl .framer-19sohj4 { aspect-ratio: 1.1934156378600822 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 160px); overflow: visible; position: absolute; right: -56px; top: 514px; width: 191px; z-index: 1; }", ".framer-7mOOl .framer-ivhii5 { flex: none; height: 20%; left: calc(50.00000000000002% - 100% / 2); overflow: hidden; position: absolute; top: calc(8.917664304910845% - 19.545565599804544% / 2); width: 100%; z-index: 0; }", ".framer-7mOOl .framer-1c2rrj0-container { flex: none; height: 720px; left: 0px; position: absolute; right: 0px; top: 0px; z-index: 1; }", ".framer-7mOOl .framer-szu5q-container { flex: none; height: auto; position: relative; width: 1248px; }", ...sharedStyle.css, ...sharedStyle1.css, '.framer-7mOOl[data-border="true"]::after, .framer-7mOOl [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }', "@media (min-width: 1280px) and (max-width: 1518.98px) { .framer-7mOOl.framer-72rtr7 { width: 1280px; } .framer-7mOOl .framer-av2csc-container, .framer-7mOOl .framer-1212kh8 { width: 100%; } .framer-7mOOl .framer-171to5k { padding: 8px 64px 8px 64px; } .framer-7mOOl .framer-p2hyij { gap: 14px; } .framer-7mOOl .framer-1i2xjtq, .framer-7mOOl .framer-1pybend, .framer-7mOOl .framer-1erp167 { order: 0; } .framer-7mOOl .framer-1hmt24w, .framer-7mOOl .framer-1goigrv, .framer-7mOOl .framer-i3vdr1 { order: 1; } .framer-7mOOl .framer-1yyjn0n { order: 5; } .framer-7mOOl .framer-8nj5qx { order: 6; } .framer-7mOOl .framer-1449j0v { order: 3; } .framer-7mOOl .framer-murt2q { order: 2; } .framer-7mOOl .framer-1an9h9 { order: 4; } .framer-7mOOl .framer-yhu483 { padding: 88px 32px 40px 32px; } .framer-7mOOl .framer-1phovde { bottom: 350px; left: -60px; top: unset; }}", "@media (min-width: 768px) and (max-width: 1279.98px) { .framer-7mOOl.framer-72rtr7 { width: 768px; } .framer-7mOOl .framer-171to5k { padding: 107px 32px 8px 32px; } .framer-7mOOl .framer-19lzdxx { flex-direction: column; } .framer-7mOOl .framer-3qczc4 { flex: none; width: 100%; } .framer-7mOOl .framer-128m11y { --border-top-width: 0px; gap: 28px; padding: 20px 0px 20px 0px; width: 90%; } .framer-7mOOl .framer-1212kh8 { height: 378px; width: 100%; } .framer-7mOOl .framer-ps4c9d { width: 95%; } .framer-7mOOl .framer-1i2xjtq { height: var(--framer-aspect-ratio-supported, 142px); order: 0; right: -69px; top: -88px; width: 170px; } .framer-7mOOl .framer-1hmt24w { bottom: unset; left: -76px; order: 1; top: 48%; transform: translateY(-50%); } .framer-7mOOl .framer-1yyjn0n { order: 5; } .framer-7mOOl .framer-17jovs7 { gap: 24px; order: 6; } .framer-7mOOl .framer-158s6tn, .framer-7mOOl .framer-1a2tpk0-container, .framer-7mOOl .framer-hheqml-container { order: 0; } .framer-7mOOl .framer-ynnrj { order: 1; } .framer-7mOOl .framer-rti5h1 { order: 2; } .framer-7mOOl .framer-1xil1if { order: 4; } .framer-7mOOl .framer-1o6f7yl { order: 3; } .framer-7mOOl .framer-1qkab9s { flex-direction: column; flex-wrap: wrap; gap: 46px; max-width: 768px; width: 90%; } .framer-7mOOl .framer-apeq29 { align-content: center; align-items: center; gap: 8px; padding: 0px; width: 100%; } .framer-7mOOl .framer-4jl14v { justify-content: flex-start; width: 100%; } .framer-7mOOl .framer-1aboqt0 { flex-direction: column; gap: 48px; } .framer-7mOOl .framer-i8rgto { flex: none; order: 0; width: 100%; } .framer-7mOOl .framer-m0m4x2 { align-content: center; align-items: center; gap: 22px; } .framer-7mOOl .framer-vjpm0g { width: min-content; } .framer-7mOOl .framer-q10wg7 { height: 41px; width: 195px; } .framer-7mOOl .framer-1p1d0l6 { justify-content: flex-end; padding: 8px; width: 211px; } .framer-7mOOl .framer-1mblgp0 { height: 62px; width: 173px; } .framer-7mOOl .framer-1an7n43 { height: 114px; width: 203px; } .framer-7mOOl .framer-ivhii5 { height: 100%; top: calc(8.917664304910845% - 100% / 2); } .framer-7mOOl .framer-szu5q-container { width: 100%; }}", "@media (max-width: 767.98px) { .framer-7mOOl.framer-72rtr7 { gap: 24px; width: 320px; } .framer-7mOOl .framer-171to5k { flex-direction: column; padding: 79px 16px 8px 16px; } .framer-7mOOl .framer-19lzdxx { flex: none; flex-direction: column; width: 100%; } .framer-7mOOl .framer-3qczc4 { flex: none; width: 100%; } .framer-7mOOl .framer-kz8x7m { gap: 11px; } .framer-7mOOl .framer-vzji2j { gap: 14px; } .framer-7mOOl .framer-pvzydo { height: min-content; justify-content: center; padding: 0px 0px 9px 0px; } .framer-7mOOl .framer-1ncsbu9 { flex: 1 0 0px; width: 1px; } .framer-7mOOl .framer-1ock6vn { flex-direction: column; gap: 9px; } .framer-7mOOl .framer-1j1qadg-container { order: 0; width: 100%; } .framer-7mOOl .framer-128m11y { flex-direction: column; gap: 46px; padding: 44px 0px 44px 0px; width: 90%; } .framer-7mOOl .framer-8e1bmi { gap: 4px; } .framer-7mOOl .framer-1quyz1w { gap: 2px; padding: 0px 16px 32px 16px; width: 100%; } .framer-7mOOl .framer-17sbmwn { order: 0; padding: 0px 0px 30px 0px; } .framer-7mOOl .framer-o9dqnn, .framer-7mOOl .framer-1zuw21, .framer-7mOOl .framer-1pybend { white-space: pre-wrap; width: 95%; word-break: break-word; word-wrap: break-word; } .framer-7mOOl .framer-k7ney { gap: 17px; grid-template-columns: repeat(2, minmax(50px, 1fr)); order: 3; } .framer-7mOOl .framer-85eg8i, .framer-7mOOl .framer-hanm0d, .framer-7mOOl .framer-1az6435, .framer-7mOOl .framer-1kndl8r, .framer-7mOOl .framer-1ao794p, .framer-7mOOl .framer-yksecg, .framer-7mOOl .framer-j97575, .framer-7mOOl .framer-1cbmlvx, .framer-7mOOl .framer-18nxhsg { gap: 12px; padding: 25px 0px 25px 0px; width: 100%; } .framer-7mOOl .framer-ofz8mk, .framer-7mOOl .framer-1j6jvka, .framer-7mOOl .framer-fxt8lq, .framer-7mOOl .framer-1g115jf, .framer-7mOOl .framer-8ev09z, .framer-7mOOl .framer-ippcvq, .framer-7mOOl .framer-1cqrde5, .framer-7mOOl .framer-1cf802q, .framer-7mOOl .framer-801utb, .framer-7mOOl .framer-487djs { height: var(--framer-aspect-ratio-supported, 65px); width: 65px; } .framer-7mOOl .framer-bzz9hc { padding: 25px 0px 25px 0px; width: 100%; } .framer-7mOOl .framer-ps4c9d { gap: 2px; padding: 0px 16px 0px 16px; width: 100%; } .framer-7mOOl .framer-1yyjn0n { gap: 4px; order: 2; padding: 0px 0px 30px 0px; } .framer-7mOOl .framer-1tzbzly { flex-wrap: wrap; gap: 22px; order: 6; } .framer-7mOOl .framer-mqt67n, .framer-7mOOl .framer-32qjfq, .framer-7mOOl .framer-qln1dk, .framer-7mOOl .framer-14xtu1x { flex: none; gap: 7px; padding: 20px; width: 100%; } .framer-7mOOl .framer-1ljrcta-container, .framer-7mOOl .framer-1z0rjbm-container { order: 0; } .framer-7mOOl .framer-yhu483 { gap: 32px; padding: 0px 16px 16px 16px; } .framer-7mOOl .framer-1qkab9s { flex-wrap: wrap; gap: 43px; order: 2; } .framer-7mOOl .framer-apeq29 { align-content: center; align-items: center; gap: 11px; padding: 0px; width: 100%; } .framer-7mOOl .framer-4jl14v, .framer-7mOOl .framer-szu5q-container { width: 100%; } .framer-7mOOl .framer-1aboqt0 { flex-direction: column; order: 3; padding: 40px 24px 8px 24px; } .framer-7mOOl .framer-i8rgto { flex: none; order: 0; width: 100%; } .framer-7mOOl .framer-vjpm0g { flex-direction: column; gap: 25px; padding: 19px 0px 0px 0px; } .framer-7mOOl .framer-q10wg7 { height: 40px; width: 192px; } .framer-7mOOl .framer-1p1d0l6 { height: min-content; padding: 39px 0px 0px 0px; } .framer-7mOOl .framer-1mblgp0 { height: 65px; width: 181px; } .framer-7mOOl .framer-1an7n43 { height: 120px; width: 213px; } .framer-7mOOl .framer-ivhii5 { height: 10%; left: calc(50.00000000000002% - 265.625% / 2); opacity: 0.46; top: calc(4.129161308758416% - 10.01571653093299% / 2); width: 266%; } .framer-7mOOl .framer-1c2rrj0-container { height: 637px; }}"];
/**
 * This is a generated Framer component.
 * @framerIntrinsicHeight 3897
 * @framerIntrinsicWidth 1519
 * @framerCanvasComponentVariantDetails {"propertyName":"variant","data":{"default":{"layout":["fixed","auto"]},"jeCnrh3kk":{"layout":["fixed","auto"]},"XWGQJU3bM":{"layout":["fixed","auto"]},"Q1XUigOVv":{"layout":["fixed","auto"]}}}
 ...
 * @framerScrollSections {"c2ZynsCbs":{"pattern":":c2ZynsCbs","name":"services"},"bj_yV4awM":{"pattern":":bj_yV4awM","name":"faq"}}
 * @framerResponsiveScreen
 */
const FrameraugiA20Il = withCSS(Component, css, "framer-7mOOl");
...
addFonts(FrameraugiA20Il, [{
    ...
    fonts: [{
        ...
        url: "https://fonts.gstatic.com/s/spacegrotesk/v22/V8mQoQDjQSkFtoMM3T6r8E7mF71Q-gOoraIAEj4PVksmNsFjTDJK.woff2",
        weight: "700"
    }, {
        cssFamilyName: "Inter",
        source: "google",
...
}, ...NavigationTopbarFonts, ...PillPillFonts, ...ButtonGlowStrokeFonts, ...ChromaBackgroundFonts, ...TickerFonts, ...NumberCounterFonts, ...CardsFeatureCard2Fonts, ...FaqAreaFonts, ...GridFonts, ...FooterFonts, ...getFontsFromSharedStyle(sharedStyle.fonts), ...getFontsFromSharedStyle(sharedStyle1.fonts)], {
