...
fontStore.loadFonts(["GF;Plus Jakarta Sans-500", "GF;Plus Jakarta Sans-700", "GF;Plus Jakarta Sans-700italic", "GF;Plus Jakarta Sans-500italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
